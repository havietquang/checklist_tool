...
{{ config(
    alias = 'v_stg_ocbchannel_branch_mapping',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('branch_mapping'),
                            dung de map dung snapshot/source table.
  - business_key_cols     : Danh sach cot tao thanh Business Key duy nhat
                            cua entity. ['branch_code']
...
{% set business_key_cols = ['branch_code'] -%}
{% set source_event_date_col = get_source_event_date_col(source_name, source_table, required=true) -%}
{% set hashdiff_satellite_dict =
{
    'hashdiff_branch_mapping': ['branch_name', 'parent_branch_code', 'date_start', 'cif', 'address', 'phone_number', 'fax', 'province', 'tax', 'branch_name_vi', 'represented_by', 'represented_position', 't24_province', 't24_district', 'is_dvkd', 'branch_short_name']
}
-%}
