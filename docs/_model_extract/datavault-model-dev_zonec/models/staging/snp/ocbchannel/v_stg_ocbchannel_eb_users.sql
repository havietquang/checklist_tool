...
{{ config(
    alias = 'v_stg_ocbchannel_eb_users',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('eb_users'),
...
{
    'hashdiff_eb_users': ['user_name', 'user_type', 'full_name', 'cif', 'representname', 'representtittle', 'user_created', 'created_date', 'branch_code', 'user_status', 'pincode', 'position', 'user_group', 'id_no', 'user_authorized', 'datetime_authorized', 'default_keyword', 'is_restrict_acc_access', 'login_fail_num', 'omni_user_id', 'last_authen_update']
}
-%}
