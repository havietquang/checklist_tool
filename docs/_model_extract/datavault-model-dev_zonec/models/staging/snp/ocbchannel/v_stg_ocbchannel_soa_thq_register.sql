...
{{ config(
    alias = 'v_stg_ocbchannel_soa_thq_register',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('soa_thq_register'),
...
{
    'hashdiff_soa_thq_register': ['serial_no', 'so_hs', 'ma_dv', 'ten_dv', 'dia_chi', 'so_cmt', 'ho_ten', 'ngay_sinh', 'nguyen_quan', 'tt_lienhe', 'taikhoan_th', 'cif', 'chung_thu_so', 'branch_code', 'status', 'status_desc', 'is_processing', 'last_access', 'created_date', 'last_update']
}
-%}
