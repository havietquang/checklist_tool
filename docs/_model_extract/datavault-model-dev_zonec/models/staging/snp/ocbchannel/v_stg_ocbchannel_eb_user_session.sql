...
{{ config(
    alias = 'v_stg_ocbchannel_eb_user_session',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('eb_user_session'),
...
{% set ma_key_expr = "cast(src.login_session as string)" -%}
{% set staging_config = get_staging_config(source_name, source_table) %}
{% set source_event_date_col = staging_config.source_event_date_col %}
{% set source_event_date_dttype = staging_config.source_event_date_dttype %}
{% set hashdiff_satellite_dict =
{
    'hashdiff_eb_user_session': ['ma_key', 'login_session', 'last_login', 'channel', 'session_expired']
}
-%}
