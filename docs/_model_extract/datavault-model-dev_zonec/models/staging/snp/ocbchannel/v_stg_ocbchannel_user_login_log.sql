...
{{ config(
    alias = 'v_stg_ocbchannel_user_login_log',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('user_login_log'),
...
{% set ma_key_expr = "cast(src.datetime_login as string)" -%}
{% set staging_config = get_staging_config(source_name, source_table) %}
{% set source_event_date_col = staging_config.source_event_date_col %}
{% set source_event_date_dttype = staging_config.source_event_date_dttype %}
{% set hashdiff_satellite_dict =
{
    'hashdiff_user_login_log': ['ma_key', 'user_name', 'web_token', 'datetime_login', 'session_status', 'lastdatetime_access', 'channel']
}
-%}
