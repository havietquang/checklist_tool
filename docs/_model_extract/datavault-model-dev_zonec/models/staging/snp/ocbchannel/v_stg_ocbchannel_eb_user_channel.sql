...
{{ config(
    alias = 'v_stg_ocbchannel_eb_user_channel_information',
    materialized = 'view',
    tags = ['ocbchannel', 'eb_user_channel_information', 'zonec']
) }}
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('eb_user_channel_information'),
