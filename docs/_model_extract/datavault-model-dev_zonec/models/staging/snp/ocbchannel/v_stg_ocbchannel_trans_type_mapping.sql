...
{{ config(
    alias = 'v_stg_ocbchannel_trans_type_mapping',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('trans_type_mapping'),
...
{% set business_key_cols = ['trans_type'] -%}
...
{
    'hashdiff_trans_type_mapping': ['ma_key', 'application', 'channel', 'decriptions', 'ofs', 't24_trans_type']
}
-%}
