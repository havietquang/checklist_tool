...
{{ config(
    alias = 'v_stg_ocbchannel_ocb_bill_providers',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('ocb_bill_providers'),
                            dung de map dung snapshot/source table.
  - business_key_cols     : Danh sach cot tao thanh Business Key duy nhat
                            cua entity. ['provider_id']
...
{% set business_key_cols = ['provider_id'] -%}
{% set source_event_date_col = get_source_event_date_col(source_name, source_table, required=true) -%}
{% set hashdiff_satellite_dict =
{
    'hashdiff_ocb_bill_providers': ['provider_name', 'provider_name_vi', 'provider_name_vins', 'provider_name_en', 'provider_name_fr', 'status', 'gateway', 'display_order', 'notes', 'datetime_created', 'trans_type', 'service_ben', 'allow_displayed', 'channel', 'fee_type', 'fee_amount', 'auto_bill', 'provider_group_code', 'provider_group_name', 'provider_order', 'save_my_bill']
}
-%}
