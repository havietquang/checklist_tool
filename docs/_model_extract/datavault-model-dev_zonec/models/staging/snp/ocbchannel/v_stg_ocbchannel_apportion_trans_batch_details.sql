...
{{ config(
    alias = 'v_stg_ocbchannel_apportion_trans_batch_details',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('apportion_trans_batch_details'),
...
{
    'hashdiff_apportion_trans_batch_details': ['ma_key', 'item_id', 'serial_no', 'cust_name', 'branch_code', 'tax', 'vat_form', 'vat_inv_code', 'vat_inv_serial', 'vat_inv_date', 'vat_inv_goods', 'vat_rate', 'debit_account', 'debit_currency', 'credit_account', 'credit_currency', 'amount', 'description', 'note', 'department_id', 'date_created', 'user_created', 'trans_type', 'status_trans', 'status', 'validate_status', 'validate_text', 'is_processing', 'processing_by', 'prev_status', 'last_access', 'ft_no', 'status_description', 'vat_type']
}
-%}
