...
{{ config(
    alias = 'v_stg_ocbchannel_eb_package_type',
    materialized = 'view',
    tags = ['ocbchannel', 'eb_package_type', 'reference', 'zonec']
) }}
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('eb_package_type'),
                            dung de map dung snapshot/source table.
  - business_key_cols     : Danh sach cot tao thanh Business Key duy nhat
                            cua entity. ['package_type_id']
...
{% set source_table = "eb_package_type" -%}
{% set business_key_cols = ['package_type_id'] -%}
