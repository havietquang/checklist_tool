...
{{ config(
    alias = 'v_stg_appsflyer_organic_uninstall_events_report',
    materialized = 'view',
    tags = ['appsflyer', 'organic_uninstall_events_report', 'phase2', 'all']
) }}
...
{% set source_table = "organic_uninstall_events_report" -%} 
