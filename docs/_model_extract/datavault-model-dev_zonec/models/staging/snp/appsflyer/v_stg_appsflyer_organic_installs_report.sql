...
{{ config(
    alias = 'v_stg_appsflyer_organic_installs_report',
    materialized = 'view',
    tags = ['appsflyer', 'organic_installs_report', 'phase2', 'all']
) }}
...
{% set source_table = "organic_installs_report" -%} 
