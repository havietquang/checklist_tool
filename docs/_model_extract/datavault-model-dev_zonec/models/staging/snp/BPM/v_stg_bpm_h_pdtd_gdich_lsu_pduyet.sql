...
*/
{{ config(
    alias = 'v_stg_bpm_h_pdtd_gdich_lsu_pduyet',
    materialized = 'view',
    tags = ['bpm', 'phase2', 'all']
) }}
...
{
    'hashdiff_h_pdtd_gdich_lsu_pduyet': ['dvi_phe_duyet','nguoi_phe_duyet','ngay_phe_duyet','noi_dung_phe_duyet','chu_thich','trang_thai','nhom_id','tham_quyen']
}
-%}
