...
*/
{{ config(
    alias = 'v_stg_bpm_tdcn_chi_tiet_san_pham',
    materialized = 'view',
    tags = ['bpm', 'phase2', 'all']
) }}
...
{
    'hashdiff_giao_dich_tdcn_chi_tiet_san_pham': ['san_pham_id','loai_san_pham','dong_xe','loai_xe','gia_tri_ts','fast_lane','gd_tsbd','trang_thai_gd_tsbd']
}
-%}
