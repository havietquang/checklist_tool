...
{% set business_key_cols = ['ma_giao_dich_pdtd', 'ma_giao_dich_xl'] -%}
{% set staging_config = get_staging_config(source_name, source_table) -%}
{% set source_event_date_col = staging_config.source_event_date_col -%}
{% set source_event_date_dttype = staging_config.source_event_date_dttype -%}
{% set hashdiff_satellite_dict =
{
    'hashdiff_link_xl_pdtd_link': ['id','gd_pdtd_id','gd_chinh_id','ngay_tao', 'gd_ngoai_bpm', 'khoan_tin_dung', 'ngay_phe_duyet']
}
-%}
/*
------------------------------------------------------------------------
...
QUALIFY ROW_NUMBER() OVER (
    PARTITION BY ma_giao_dich_pdtd, ma_giao_dich_xl
