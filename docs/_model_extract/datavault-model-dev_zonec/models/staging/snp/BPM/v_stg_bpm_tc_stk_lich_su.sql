...
*/
{{ config(
    alias = 'v_stg_bpm_tc_stk_lich_su',
    materialized = 'view',
    tags = ['bpm', 'phase2', 'all']
) }}
...
{
    'hashdiff_giao_dich_tc_stk_lich_su': ['id','ma_giao_dich','process_id','trang_thai_bpm','ngay_phe_duyet','nguoi_phe_duyet','ngay_xuat_file','dien_giai_loi_bpm','ngay_tao']
}
-%}
