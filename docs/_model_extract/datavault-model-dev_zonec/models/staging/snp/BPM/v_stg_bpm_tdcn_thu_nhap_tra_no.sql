...
*/
{{ config(
    alias = 'v_stg_bpm_tdcn_thu_nhap_tra_no',
    materialized = 'view',
    tags = ['bpm', 'phase2', 'all']
) }}
...
{
    'hashdiff_giao_dich_tdcn_thu_nhap_tra_no': ['thu_nhap_cua','chi_tiet_nguon_tn','so_tien','ngay_tao','ngoai_le_thu_nhap_tra_no','noi_dung_ngoai_le','chung_tu_nguon_thu']
}
-%}
