...
{
    'hashdiff_giao_dich_the': ['id','kh_id','so_the','loai_the','loai_the_t24','loai_the_chi_tiet','ten_in_tren_the','han_muc_de_xuat','han_muc_phe_duyet','dia_chi','the_chinh_phu','tinh_trang_the','so_tk_the','tinh_trang_tk_the','the_pre_approved','nhom_cskh','hieu_luc_the','branch_code','phat_hanh_the_phu','y_kien','sys_date','loai_the_ttt','status_code','reason_message']
}
-%}
