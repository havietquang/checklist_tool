...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('pdtd_san_pham'),
                            dung de map dung snapshot/source table.
  - business_key_cols     : Danh sach cot tao thanh Business Key duy nhat
                            cua entity. ['GD_CHINH_ID', 'SAN_PHAM_ID']
...
{
    'hashdiff_pdtd_san_pham': ['rowid', 'datadate', 'gd_chinh_id', 'muc_dich_id', 'nhom_san_pham_id', 'san_pham_id', 'loai_san_pham', 'so_tien_de_xuat', 'so_tien_phe_duyet', 'ngay_tao', 'rrtd_co_tsbd_sp_cuthe', 'rrtd_ko_tsbd_sp_cuthe', 'rrtd_co_tsbd_sp_cuthe_pd', 'rrtd_ko_tsbd_sp_cuthe_pd', 'du_no_hien_tai', 'rrtd_da_phe_duyet', 'ngay_het_han_hieu_luc_hm', 'ngay_lap_tt_ph_ckctd', 'ngay_du_kien_ph_ckctd']
}
-%}
...
select
    ...
    --EXTRA COLUMNS
    CAST(src.san_pham_id AS STRING) AS ma_key,
...
QUALIFY ROW_NUMBER() OVER (
    PARTITION BY gd_chinh_id, san_pham_id
