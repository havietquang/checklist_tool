{{ config(
    alias = 'v_stg_bpm_sk10_san_pham',
    materialized = 'view',
    tags = ['bpm', 'reference', 'phase1', 'all']
) }}

{% set source_name = "bpm" -%}
{% set source_table = "sk10_san_pham" -%}
{% set business_key_cols = ['id', 'ma_san_pham'] -%}
...
{% set list_cols = ['id', 'ma_san_pham', 'ten_san_pham', 'phan_nhom_san_pham', 'parent_group', 'hieu_luc_sp', 'ghi_chu', 'category_t24', 'loan_support_t24', 'dieu_kien_t24'] -%}
