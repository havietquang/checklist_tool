...
{{ config(
    alias = 'v_stg_bpm_giao_dich_tsbd',
    materialized = 'view',
    tags = ['bpm', 'phase1', 'all']
) }}
...
{
    'hashdiff_giao_dich_tsbd': ['ma_tsbd', 'quy_trinh', 'ngay_tao', 'ngay_cap_nhat', 'nguoi_tao', 'ngay_phat_hanh', 'ngay_den_han', 'gia_tri', 'loai_tien_gui', 'ti_le_bd', 'tinh_trang_phong_toa', 'muc_bao_dam', 'chu_so_huu', 'loai_tien_t24', 'cif', 'cmnd']
}    
-%}
