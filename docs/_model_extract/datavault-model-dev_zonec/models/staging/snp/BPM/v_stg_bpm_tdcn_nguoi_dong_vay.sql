...
*/
{{ config(
    alias = 'v_stg_bpm_tdcn_nguoi_dong_vay',
    materialized = 'view',
    tags = ['bpm', 'phase2', 'all']
) }}
...
{
    'hashdiff_giao_dich_tdcn_nguoi_dong_vay': ['parent_id','sub_id','ngay_sinh','khach_hang_no','so_cif','quan_he_id','quoc_tich','thoi_gian_con_o_vn','so_tuoi','ngay_tao']
}
-%}
