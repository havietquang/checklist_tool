...
{{ config(
    alias = 'v_stg_bpm_auth_nhan_vien',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('auth_nhan_vien'),
                            dung de map dung snapshot/source table.
  - business_key_cols     : Danh sach cot tao thanh Business Key duy nhat
                            cua entity. ['ten_dang_nhap']
                            Macro se hash cac cot nay thanh hashkey.
  - source_event_date_col : None = nguon khong co cot ngay su kien ro rang;
                            macro se dung ngay load thay the.
  - hashdiff_satellite_dict: Dictionary anh xa ten hashdiff -> danh sach
                            cot tuong ung. Entry nay gom thong tin tai khoan
                            va trang thai nhan vien phat sinh tu BPM.
========================================================================
*/

{% set source_name = "bpm" -%}
{% set source_table = "auth_nhan_vien" -%}
{% set business_key_cols = ['ten_dang_nhap'] -%}
{% set source_event_date_col = get_source_event_date_col(source_name, source_table, required=true) -%}
{% set hashdiff_satellite_dict =
{
    'hashdiff_auth_nhan_vien': ['ten_dang_nhap', 'ten_nguoi_dung', 'ocb_hrm_uid', 'trang_thai', 'ghi_chu', 'is_lock', 'ngay_thay_doi', 'nhan_vien_qly', 'email', 'user_id_thay_doi', 'so_dien_thoai', 'chuc_danh', 'diem_min', 'id']
}
-%}
