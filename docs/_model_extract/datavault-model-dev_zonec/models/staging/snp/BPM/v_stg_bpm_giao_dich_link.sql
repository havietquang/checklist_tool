...
{{ config(
    alias = 'v_stg_bpm_giao_dich_link',
    materialized = 'view',
    tags = ['bpm', 'phase1', 'all']
) }}
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('giao_dich_link'),
                            dung de map dung snapshot/source table.
  - business_key_cols     : None = model dang stage du lieu lien ket,
                            khong khai bao danh sach cot Business Key
                            truc tiep o phan tham so nay.
  - source_event_date_col : Cot ngay su kien tu nguon ('DATADATE'),
                            dung lam `source_event_date` o downstream.
  - hashdiff_satellite_dict: Dictionary anh xa ten hashdiff -> danh sach
                            cot tuong ung, phan anh thong tin lien ket
                            va phe duyet cua giao dich.
========================================================================
*/

{% set source_name = "bpm" -%}
{% set source_table = "giao_dich_link" -%}
{% set business_key_cols = ['gd_id','ma_gd_link'] -%}
{% set source_event_date_col = get_source_event_date_col(source_name, source_table, required=true) -%}
{% set hashdiff_satellite_dict =
{
    'hashdiff_link_giao_dich_link': ['id', 'quy_trinh_link', 'giao_dich_ngoai_bpm', 'quy_trinh_con', 'cap_phe_duyet', 'nguoi_phe_duyet', 'y_kien_phe_duyet', 'so_tien', 'ngay_phe_duyet', 'mo_ta', 'loai_giao_dich', 'luong_them']
}
-%}
