...
{{ config(
    alias = 'v_stg_bpm_tdcn_thong_tin_chung',
    materialized = 'view',
    tags = ['bpm', 'phase1', 'all']
) }}
...
{
    'hashdiff_giao_dich_tdcn_thong_tin_chung': ['id','xep_hang_tin_dung','tt_ngoai_le','hinh_thuc_bd','luong_xu_ly','luong_soan_thao','luong_phe_duyet','is_thay_doi_tt','ngay_tao','nguoi_tao','so_cap_duyet','vi_tri_buoc_giao_dich','rating_id','noi_cu_tru','is_dong_vay','tong_thu_nhap_tra_no','no_thang_dau','no_hien_co','no_tai_tctd_khac','dti','so_tuoi','dieu_kien_sp_id','ly_do','trang_thai_tdtt','thoi_diem_tdtt','kctd_ngoai_le_cho_vay','kctd_ngoai_le_tin_dung','kctd_ngoai_le_xep_hang_kh','kctd_ngoai_le_sp_tin_dung','kctd_trinh_ybtd','tsbd_phai_duoc_ubtd_pd','thanh_vien_pos','thanh_vien_ubtd','muc_dich_xhtd','is_dong_vay_nhphoi','soan_thao_hs','xu_ly_hs','is_phap_che','loai_gd','dvi_trien_khai','kh_adgiam_tat_rb']
}
-%}
