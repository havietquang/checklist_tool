...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_drawings'),
...
{
    'hashdiff_drawings_information': ['t_drawing_type', 't_draw_currency', 't_document_amount', 't_payment_amount', 't_value_date', 't_presenting_date', 't_adv_mat_date', 't_maturity_review', 't_payment_method', 't_discrepancy', 't_presentor_cust', 't_presentor', 't_payment_account', 't_link_ld_ref'],
    'hashdiff_drawings_other': ['t_ben_draw_amt', 't_drawdown_account', 't_reimburse_amount', 't_presentor_reference'],
    'hashdiff_drawings_system': ['t_record_status', 't_inputter', 't_authoriser'],
}
-%}
