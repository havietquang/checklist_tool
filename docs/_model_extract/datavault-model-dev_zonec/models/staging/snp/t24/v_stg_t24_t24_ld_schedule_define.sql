...
{{ config(
    alias = 'v_stg_t24_t24_ld_schedule_define',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ld_schedule_define'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ld_schedule_define" -%}
...
{
    'hashdiff_loans_schedule': ['t_k_date', 't_sch_type', 't_frequency', 't_number', 't_cycled_dates', 't_currency', 't_amount', 't_date_time'],
}
-%}
