...
{{ config(
    alias = 'v_stg_t24_t24_department',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_department'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_department" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_description', 't_group_id'] -%}
