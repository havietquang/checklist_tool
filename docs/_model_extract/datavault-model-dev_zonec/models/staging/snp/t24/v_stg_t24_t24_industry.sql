...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_industry'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_industry" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_description', 't_sbv_industry', 't_sub_industry', 't_active'] -%}
