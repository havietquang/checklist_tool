...
{{ config(
    alias = 'v_stg_t24_t24_ocbt_sub_industry',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ocbt_sub_industry'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ocbt_sub_industry" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_sub_industry_name', 't_id_parent', 't_order', 't_active'] -%}
