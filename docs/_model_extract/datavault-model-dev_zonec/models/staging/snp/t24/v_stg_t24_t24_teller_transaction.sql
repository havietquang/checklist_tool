...
{{ config(
    alias = 'v_stg_t24_t24_teller_transaction',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_teller_transaction'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_teller_transaction" -%}
{% set business_key_cols = ['id'] -%}          
{% set list_cols = ['id', 't_short_desc', 't_desc', 't_transaction_code_1', 't_transaction_code_2', 't_record_status', 't_curr_no', 't_inputter', 't_date_time', 't_authoriser', 't_co_code', 't_dept_code'] -%}
