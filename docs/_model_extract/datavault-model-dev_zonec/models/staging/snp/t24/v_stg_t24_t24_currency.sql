...
{{ config(
    alias = 'v_stg_t24_t24_currency',
    materialized = 'view',
    tags = ['t24', 'currency', 'reference', 'phase1', 'all', 'bv_zonec']
) }}
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_currency'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_currency" -%}
{% set business_key_cols = ['id'] -%}
{% set source_event_date_dttype = 'yyyyMMdd'%}
-- Lấy toàn bộ bản ghi các ngày 
{% set source_event_date_col = none -%}
