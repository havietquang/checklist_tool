...
{{ config(
    alias = 'v_stg_t24_t24_ocbh_coll_rev_agent',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ocbh_coll_rev_agent'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ocbh_coll_rev_agent" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_description', 't_inputter', 't_authoriser', 't_date_time'] -%}
