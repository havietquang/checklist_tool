...
{{ config(
    alias = 'v_stg_t24_t24_ld_aprv_user',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ld_aprv_user'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ld_aprv_user" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_app_user_name', 't_ubtd1', 't_ubtd2', 't_ubtd3', 't_direct_aprv', 't_indirect_aprv', 't_reval_level', 't_active_info', 't_user_status', 't_curr_no', 't_inputter', 't_authoriser', 't_date_time'] -%}
