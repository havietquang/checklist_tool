...
{{ config(
    alias = 'v_stg_t24_t24_re_stat_line_cont',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_re_stat_line_cont'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_re_stat_line_cont" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_type', 't_desc', 't_profit_ccy', 't_asst_consol_key', 't_asset_type', 't_prft_consol_key'] -%}
