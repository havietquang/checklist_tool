...
{{ config(
    alias = 'v_stg_t24_t24_ld_aprv_info',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ld_aprv_info'),
...
{
    'hashdiff_ld_aprv_information': ['t_aprv_dte', 't_aprv_level', 't_aprv_name', 't_aprv_reval_name', 't_aprv_chg_dte', 't_aprv_chg_des', 't_aprv_chg_level', 't_aprv_chg_name', 't_aprv_chg_revname']
}
-%}
