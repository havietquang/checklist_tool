...
{{ config(
    alias = 'v_stg_t24_t24_sc_trans_pos_history',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_sc_trans_pos_history'),
