...
{{ config(
    alias = 'v_stg_t24_t24_ocbh_sub_virtual_account',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ocbh_sub_virtual_account'),
...
{% set hashdiff_satellite_dict = {
    'hashdiff_virtual_account': ['t_va_id','t_sub_va_name','t_credit_acct_spa','t_sva_record_status','t_sva_status','t_date_time_input','t_date_time_approval','t_sub_id']
} -%}
