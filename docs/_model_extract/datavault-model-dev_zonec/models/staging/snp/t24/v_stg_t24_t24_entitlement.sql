...
{{ config(
    alias = 'v_stg_t24_t24_entitlement',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_entitlement'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_entitlement" -%}
...
{
    'hashdiff_entitlement': ['ma_key', 't_portfolio_no', 't_security_no', 't_record_status', 't_entitlement_amt', 't_event_type'],
}
-%}
