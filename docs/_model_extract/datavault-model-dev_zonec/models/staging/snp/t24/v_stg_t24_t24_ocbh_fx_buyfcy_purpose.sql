...
{{ config(
    alias = 'v_stg_t24_t24_ocbh_fx_buyfcy_purpose',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ocbh_fx_buyfcy_purpose'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ocbh_fx_buyfcy_purpose" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_description'] -%}
