...
{{ config(
    alias = 'v_stg_t24_t24_account_credit_int',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_account_credit_int'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_account_credit_int" -%}
...
{
    'hashdiff_account_credit_int_information': ['ma_key','t_interest_day_basic','t_cr_balance_type','t_cr_calcul_type','t_cr_int_rate','t_cre_margin_rate','t_cr_minimum_bal']
}
-%}
