...
{{ config(
    alias = 'v_stg_t24_t24_posting_restrict',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_posting_restrict'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_posting_restrict" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_description', 't_restriction_type', 't_dispo_officer', 't_allow_txn', 't_txn_code', 't_local_ref', 't_alt_override', 't_block_reason_codes', 't_unblock_reason_codes', 't_co_code'] -%}
