...
{{ config(
    alias = 'v_stg_t24_t24_consolidate_prft_loss',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_consolidate_prft_loss'),
...
{
    'hashdiff_consolidate_profit_n_loss_information': ['t_currency','t_pl_category','t_balance_ytd','t_ccy_balance_ytd'],
