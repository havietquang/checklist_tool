...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_lc_types'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_lc_types" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_description', 't_category_code', 't_import_export'] -%}
