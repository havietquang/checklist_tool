...
{{ config(
    alias = 'v_stg_t24_t24_ocbh_md_purpose',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ocbh_md_purpose'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ocbh_md_purpose" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_purpose_name', 't_parent_id', 't_n_used'] -%}
