...
{{ config(
    alias = 'v_stg_t24_t24_collateral_right',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_collateral_right'),
...
{
    'hashdiff_collateral_right_information': ['t_limit_ref_cust', 't_percent_alloc', 't_validity_date', 't_expiry_date', 't_status', 't_inputter', 't_authoriser'],
}
-%}
