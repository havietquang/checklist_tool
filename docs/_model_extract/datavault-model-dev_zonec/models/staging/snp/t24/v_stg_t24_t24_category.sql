...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_category'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_category" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_description', 't_short_name', 't_product', 't_prod_id', 't_co_vat', 't_type_business', 't_is_mand'] -%}
