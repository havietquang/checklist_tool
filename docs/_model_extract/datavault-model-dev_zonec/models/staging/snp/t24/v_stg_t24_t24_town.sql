...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_town'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_town" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_order', 't_active', 't_town_name', 't_province', 't_ocb_town_nation'] -%}
