...
{{ config(
    alias = 'v_stg_t24_t24_limit_reference',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_limit_reference'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_limit_reference" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_limit_reference', 't_description', 't_short_name', 't_reducing_limit', 't_reference_child', 't_record_status', 't_curr_no', 't_inputter', 't_authoriser', 't_date_time', 't_co_code'] -%}
