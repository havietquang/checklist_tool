...
{{ config(
    alias = 'v_stg_t24_t24_bc_sort_code',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_bc_sort_code'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_bc_sort_code" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_name', 't_telephone_no', 't_identity_kind'] -%}
