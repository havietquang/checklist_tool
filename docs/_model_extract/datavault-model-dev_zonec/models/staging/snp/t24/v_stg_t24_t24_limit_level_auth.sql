...
{{ config(
    alias = 'v_stg_t24_t24_limit_level_auth',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_limit_level_auth'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_limit_level_auth" -%}
{% set business_key_cols = ['id'] -%}          
{% set list_cols = ['id', 't_limit_amount'] -%}
