...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_crb'),
                            dung de map dung snapshot/source table.
  - business_key_cols     : Danh sach cot tao thanh Business Key duy nhat
                            cua entity. ['tieukhoan','gl']
...
{% set business_key_cols = ['tieukhoan','gl'] -%}
{% set ma_key_expr = "cast(data_date as string)" -%}
...
{
    'hashdiff_crb_balance': ['ma_key', 'ngoaite', 'ngoaite1', 'noite', 'category'],
    'hashdiff_crb_information': ['ma_key', 'sotkcu', 'laisuat', 'kyhan', 'startdate', 'enddate', 'masp', 'laidatra', 'loanclass', 'ten'],
}
-%}
