...
{{ config(
    alias = 'v_stg_t24_t24_ocbh_coll_borrow_purpose',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ocbh_coll_borrow_purpose'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ocbh_coll_borrow_purpose" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 'id2', 't_detail', 't_curr_no', 't_inputter', 't_date_time', 't_authoriser', 't_co_code', 't_dept_code'] -%}
