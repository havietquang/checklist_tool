...
{{ config(
    alias = 'v_stg_t24_t24_bank_assure_inp',
    materialized = 'view',
    tags = ['t24', 'loan', 'phase2', 'all', 'bv_zonec']
) }}
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_bank_assure_inp'),
...
{% set business_key_cols = ["t_contract_ld"] -%}
{% set ma_key_expr = "id" -%}
...
{
    'hashdiff_bank_assure_inp': ['ma_key', 't_ccy_assr', 't_cr_product_code', 't_assr_request_date', 't_assr_begin_date', 't_assr_end_date', 't_fee_rate', 't_pay_fee_period', 't_first_term_amt', 't_next_fee_cal_date', 't_next_int_begin_date', 't_next_int_end_date', 't_loan_amount', 't_paid_int_freq', 't_paid_ori_freq', 't_advisory_cadre', 't_info_note', 't_co_code', 't_first_fee_cal_date'],
}
-%}
