...
{{ config(
    alias = 'v_stg_t24_t24_acct_activity',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_acct_activity'),
...
{
    'hashdiff_acct_activity': ['ma_key', 't_day_no', 't_turnover_credit', 't_turnover_debit', 't_balance', 't_transact_code', 't_no_of_transact', 't_transact_amt', 't_bk_day_no', 't_bk_balance', 't_bk_credit_mvmt', 't_bk_debit_mvmt']
}
-%}
