...
{{ config(
    alias = 'v_stg_t24_t24_ld_partner',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ld_partner'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ld_partner" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_name', 't_record_status', 't_curr_no', 't_inputter', 't_date_time', 't_authoriser'] -%}
