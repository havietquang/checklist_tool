...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_cus_pkg'),
...
{
    'hashdiff_cust_package': ['t_product_package_id', 't_begin_date', 't_expire_date', 't_curr_no', 't_inputter', 't_date_time', 't_authoriser', 't_dept_code', 't_account_charge', 't_partner_id']
} 
-%}
