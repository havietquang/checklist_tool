...
{{ config(
    alias = 'v_stg_t24_t24_stmt_acct_cr',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_stmt_acct_cr'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_stmt_acct_cr" -%}
{% set business_key_cols = ["split_part(id, '-', 1)"] -%}
{% set ma_key_expr = "trim(split_part(id, '-', 2))" -%}
...
{
    'hashdiff_stmt_acct_cr': ['ma_key', 't_liquidity_ccy', 't_period_first_date', 't_period_last_date', 't_cr_int_rate', 't_cr_int_date', 't_cr_no_of_days', 't_cr_int_amt', 't_cr_int_categ', 't_cr_val_balance', 't_cr_int_tr_ac', 't_cr_int_tr_pl', 't_liquidity_account', 't_compens_account', 't_int_no_booking', 't_total_interest', 't_grand_total', 't_cr_min_value', 't_cr_min_waive', 't_unadj_total_int', 't_int_post_date'],
    'hashdiff_stmt_acct_cr_other': ['ma_key', 't_cr_int_tax_code', 't_cr_int_tax_rate', 't_cr_int_tax_amt', 't_cr_int_taxcateg', 't_cr_int_taxtrsdr', 't_cr_int_taxtrscr', 't_tax_for_customer', 't_tax_for_bank', 't_ica_int_categ', 't_ica_tr_ac', 't_ica_tr_pl', 't_ica_main_int', 't_ica_sub_int', 't_ica_post_interest', 't_ica_main_acct', 't_ica_dist_type', 't_ica_dist_ratio', 't_tax_exch_rate', 't_manual_adj_amt', 't_correction_number', 't_correction_id', 't_adj_int_amt', 't_adj_tax_amt', 't_withheld_int_amt', 't_db_netting_amt', 't_correction_date']
}
-%}
