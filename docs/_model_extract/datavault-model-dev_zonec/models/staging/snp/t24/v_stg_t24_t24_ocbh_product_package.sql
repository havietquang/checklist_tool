...
{{ config(
    alias = 'v_stg_t24_t24_ocbh_product_package',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ocbh_product_package'),
