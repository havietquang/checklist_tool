...
*/
{{ config(
    alias = 'v_stg_t24_t24_ocbh_ac_restrict',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Tên bảng nghiệp vụ nguồn ('t24_ocbh_ac_restrict'),
...
{
    'hashdiff_ac_restrict': ['t_customer', 't_ac_title', 't_category', 't_currency', 't_ac_restrict', 't_res_customer', 't_res_ac_title', 't_res_category', 't_res_currency', 't_inputter', 't_authoriser', 't_date_time', 't_co_code'],
}
-%}
