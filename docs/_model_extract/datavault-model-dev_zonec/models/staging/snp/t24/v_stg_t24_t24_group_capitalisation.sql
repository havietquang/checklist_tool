...
{{ config(
    alias = 'v_stg_t24_t24_group_capitalisation',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_group_capitalisation'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_group_capitalisation" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['data_date', 't_dr_cap_frequency', 't_cr_cap_frequency', 't_settle_acct_close', 't_start_of_day_cap'] -%}
