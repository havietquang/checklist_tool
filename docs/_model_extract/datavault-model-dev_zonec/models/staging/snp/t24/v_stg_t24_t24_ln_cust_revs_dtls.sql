...
{{ config(
    alias = 'v_stg_t24_t24_ln_cust_revs_dtls',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ln_cust_revs_dtls'),
...
{% set hashdiff_satellite_dict = {
    'hashdiff_ln_cust_revs_dtls': ['t_date', 'account_balance', 'total_accrual', 'contract_id', 'outs_amount', 'currency', 'k_type', 'outs_accr_int', 'stmt_no', 't_line_no', 't_account_no', 't_pre_line_no', 't_pre_account_no'],
    'hashdiff_pdpd_ln_cust_revs_dtls': ['t_date','account_balance','total_accrual','contract_id','outs_amount','currency','k_type','outs_accr_int','stmt_no','t_line_no','t_account_no','t_pre_line_no','t_pre_account_no']
} -%}
