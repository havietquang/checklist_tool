...
{{ config(
    alias = 'v_stg_t24_t24_ocbh_loan_pro_bundle',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ocbh_loan_pro_bundle'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ocbh_loan_pro_bundle" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 'description', 'sub_product'] -%}
