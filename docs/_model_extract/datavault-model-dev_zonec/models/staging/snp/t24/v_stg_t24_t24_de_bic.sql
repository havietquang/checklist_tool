...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_de_bic'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_de_bic" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_institution', 't_city', 't_address', 't_country', 't_subtype_ind', 't_recordkey', 't_branch', 't_bic_code'] -%}
