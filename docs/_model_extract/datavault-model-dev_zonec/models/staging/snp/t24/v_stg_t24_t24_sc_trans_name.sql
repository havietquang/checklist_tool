...
{{ config(
    alias = 'v_stg_t24_t24_sc_trans_name',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_sc_trans_name'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_sc_trans_name" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_short_name'] -%}
