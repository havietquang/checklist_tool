...
{{ config(
    alias = 'v_stg_t24_t24_ft_txn_type_condition',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ft_txn_type_condition'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ft_txn_type_condition" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_short_descr', 't_txn_code_cr', 't_txn_code_dr', 't_sto_txn_code_cr', 't_sto_txn_code_dr'] -%}
