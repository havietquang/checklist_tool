...
{{ config(
    alias = 'v_stg_t24_t24_ocbh_deposit_prgm',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ocbh_deposit_prgm'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ocbh_deposit_prgm" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_prgm_name', 't_begin_date', 't_end_date', 't_co_code'] -%}
