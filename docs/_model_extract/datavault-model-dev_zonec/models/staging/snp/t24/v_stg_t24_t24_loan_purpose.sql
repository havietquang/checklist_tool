...
{{ config(
    alias = 'v_stg_t24_t24_loan_purpose',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_loan_purpose'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_loan_purpose" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_description', 't_level_1', 't_level_1_desc', 't_level_2', 't_level_2_desc', 't_record_status', 't_curr_no', 't_inputter', 't_authoriser', 't_date_time', 't_co_code', 't_category'] -%}
