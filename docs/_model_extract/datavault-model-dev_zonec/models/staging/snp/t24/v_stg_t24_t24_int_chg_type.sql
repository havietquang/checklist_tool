...
{{ config(
    alias = 'v_stg_t24_t24_int_chg_type',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_int_chg_type'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_int_chg_type" -%}
{% set business_key_cols = ['id'] -%}           
{% set list_cols = ['id', 't_descriptions', 't_frequency'] -%}
