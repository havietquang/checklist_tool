...
{{ config(
    alias = 'v_stg_t24_t24_comp_level_group',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_comp_level_group'),
...
{
    'hashdiff_branch_comp_level_group': ['t_description', 't_level2_comp', 't_lead_company'],
}
-%}
