...
{{ config(
    alias = 'v_stg_t24_t24_sec_acc_master',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_sec_acc_master'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_sec_acc_master" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_account_officer', 't_customer_number', 't_reference_currency', 't_account_name', 't_date_of_valuation', 't_start_date', 't_co_code', 't_portfolio_type'] -%}
