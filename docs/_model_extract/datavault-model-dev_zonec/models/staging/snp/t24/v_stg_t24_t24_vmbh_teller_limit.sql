...
{{ config(
    alias = 'v_stg_t24_t24_vmbh_teller_limit',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_vmbh_teller_limit'),
...
{
    'hashdiff_teller_limit': ['t_ccy', 't_txn_cod', 't_limit_amount', 't_co_code', 't_date_time', 't_curr_mo', 't_inputter', 't_authoriser'],
}
-%}
