...
{{ config(
    alias = 'v_stg_t24_t24_ocbh_ft_outward_purpose',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ocbh_ft_outward_purpose'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ocbh_ft_outward_purpose" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_purpose_type', 't_desc', 't_cus_type'] -%}
