...
{{ config(
    alias = 'v_stg_t24_t24_collateral_code',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_collateral_code'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_collateral_code" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_collateral_code', 't_description', 't_short_name', 't_collateral_type', 't_record_status', 't_curr_no', 't_inputter', 't_authoriser', 't_date_time', 't_co_code'] -%}
