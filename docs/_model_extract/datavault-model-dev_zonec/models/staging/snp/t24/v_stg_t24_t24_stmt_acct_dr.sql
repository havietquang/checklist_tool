...
{{ config(
    alias = 'v_stg_t24_t24_stmt_acct_dr',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_stmt_acct_dr'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_stmt_acct_dr" -%}
...
{
    'hashdiff_stmt_acct_dr': ['ma_key', 't_liquidity_ccy', 't_period_first_date', 't_period_last_date', 't_dr_int_rate', 't_dr_int_date', 't_dr_no_of_days', 't_dr_int_amt', 't_dr_int_categ', 't_dr_val_balance', 't_dr_int_tr_ac', 't_dr_int_tr_pl']
}
-%}
