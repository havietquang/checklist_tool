...
{{ config(
    alias = 'v_stg_t24_t24_ocbh_ld_prod_main',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ocbh_ld_prod_main'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ocbh_ld_prod_main" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_name', 't_category', 't_record_status', 't_curr_no', 't_inputter', 't_date_time', 't_authoriser', 't_co_code', 't_dept_code', 't_auditor_code', 't_audit_date_time'] -%}
