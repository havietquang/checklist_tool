...
{{ config(
    alias = 'v_stg_t24_t24_acct_group_condition',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_acct_group_condition'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_acct_group_condition" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['t_minimum_bal', 't_curr_no', 'inputter', 't_date_time', 't_authoriser'] -%}
