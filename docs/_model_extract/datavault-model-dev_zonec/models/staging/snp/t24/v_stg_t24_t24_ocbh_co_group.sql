...
{{ config(
    alias = 'v_stg_t24_t24_ocbh_co_group',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ocbh_co_group'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ocbh_co_group" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['ID', 'DESCRIPTION', 'MVALUE'] -%}
