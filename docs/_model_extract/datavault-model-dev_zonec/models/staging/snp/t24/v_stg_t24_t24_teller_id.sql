...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_teller_id'),
...
{
    'hashdiff_teller_id': ['t_status','t_user','t_date_of_open','t_time_of_open','t_date_of_close','t_time_of_close','t_curr_no','t_inputter','t_date_time','t_authoriser','t_co_code','t_dept_code','t_till_limit']
} -%}
