...
{{ config(
    alias = 'v_stg_t24_t24_apportion_acct_categ',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_apportion_acct_categ'),
...
{
    'hashdiff_apportion_acct_categ': ['t_parent_account','t_level3','t_line','t_account_name','t_categ_internal','t_cust_group','t_no','t_categ_pl','t_type_business','t_is_mand','t_categ_type','t_from_date','t_status','t_pbnb']
} -%}
/*
------------------------------------------------------------------------
STAGE MACRO CALL
