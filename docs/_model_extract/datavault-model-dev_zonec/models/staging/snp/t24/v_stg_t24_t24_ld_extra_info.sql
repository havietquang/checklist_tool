...
{{ config(
    alias = 'v_stg_t24_t24_ld_extra_info',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ld_extra_info'),
...
{
    'hashdiff_ld_extra_information': ['t_note', 't_record_status', 't_curr_no', 't_inputter', 't_authoriser', 't_date_time', 't_ftp_int_rate_tp', 't_ocbint_chg_date', 't_ftp_nd_term_int', 't_ftp_fee_repaid'],
}
-%}
