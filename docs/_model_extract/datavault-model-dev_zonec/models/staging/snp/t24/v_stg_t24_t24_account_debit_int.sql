...
{{ config(
    alias = 'v_stg_t24_t24_account_debit_int',
    materialized = 'view',
    tags = ['t24', 'account', 'phase2', 'phase1', 'all', 'bv_zonec']
) }}
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_account_debit_int'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_account_debit_int" -%}
...
{
    'hashdiff_account_debit_int_information': [ 'ma_key','t_charge_key','t_interest_day_basis','t_dr_balance_type','t_dr_calcul_type','t_dr_int_rate','t_dr_margin_rate','t_dr_basic_rate','t_dr_margin_oper']
}
-%}
