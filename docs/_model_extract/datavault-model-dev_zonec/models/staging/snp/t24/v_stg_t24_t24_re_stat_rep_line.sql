...
{{ config(
    alias = 'v_stg_t24_t24_re_stat_rep_line',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_re_stat_rep_line'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_re_stat_rep_line" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_k_type', 't_desc', 't_co_code', 't_inputter', 't_date_time', 't_authoriser'] -%}
