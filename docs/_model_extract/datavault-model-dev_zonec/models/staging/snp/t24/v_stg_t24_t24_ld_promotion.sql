...
{{ config(
    alias = 'v_stg_t24_t24_ld_promotion',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ld_promotion'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ld_promotion" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_description', 't_record_status', 't_curr_no', 't_inputter', 't_date_time', 't_authoriser'] -%}
