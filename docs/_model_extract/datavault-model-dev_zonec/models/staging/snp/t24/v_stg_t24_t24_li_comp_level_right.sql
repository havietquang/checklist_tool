...
{{ config(
    alias = 'v_stg_t24_t24_li_comp_level_right',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_li_comp_level_right'),
...
{
    'hashdiff_branch_li_comp_level_right': ['t_description', 't_parent_company', 't_currency', 't_cust_type', 't_amount', 't_lead_company'],
}
-%}
