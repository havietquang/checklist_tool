...
{{ config(
    alias = 'v_stg_t24_t24_ld_economic_sector',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ld_economic_sector'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ld_economic_sector" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_description', 't_parent_id'] -%}
