...
{{ config(
    alias = 'v_stg_t24_t24_periodic_interest',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_periodic_interest'),
...
{
    'hashdiff_periodic_interest': ['t_description','t_default_mis_table','t_rest_date','t_days_since_spot','t_bid_rate','t_offer_rate','t_rest_period','t_record_status','t_curr_no','t_inputter','t_authoriser','t_date_time','t_co_code']
} -%}
