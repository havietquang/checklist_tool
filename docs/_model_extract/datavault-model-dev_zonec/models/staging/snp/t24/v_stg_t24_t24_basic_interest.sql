...
{{ config(
    alias = 'v_stg_t24_t24_basic_interest',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_basic_interest'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_basic_interest" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_interest_rate', 't_record_status', 't_curr_no', 't_inputter', 't_authoriser', 't_date_time', 't_co_code'] -%}
