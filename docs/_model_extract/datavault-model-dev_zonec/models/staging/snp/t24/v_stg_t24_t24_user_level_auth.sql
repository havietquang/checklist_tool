...
{{ config(
    alias = 'v_stg_t24_t24_user_level_auth',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_user_level_auth'),
...
{
    'hashdiff_user_level_auth': ['t_co_code', 't_auth_level_default', 't_auth_level_short_term', 't_begin_date', 't_expire_date', 't_value_date'],
}
-%}
