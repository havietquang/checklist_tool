...
{{ config(
    alias = 'v_stg_t24_t24_sub_asset_type',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_sector'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_sub_asset_type" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_description', 't_short_descr', 't_asset_type_code'] -%}
