...
{{ config(
    alias = 'v_stg_t24_t24_ocbh_industry_tt15',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ocbh_industry_tt15'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_ocbh_industry_tt15" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['t_industry_tt15_l1', 't_industry_tt15_l2', 't_industry_tt15_l3', 't_industry_name'] -%}
