...
{{ config(
    alias = 'v_stg_t24_t24_denom_exchange',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_denom_exchange'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_denom_exchange" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['data_date', 't_denomination', 't_denom_buy_rate', 't_denom_sell_rate', 't_denom_revl_rate', 't_denom_rate_sprd', 't_curr_no', 't_inputter', 't_date_time', 't_authoriser'] -%}
