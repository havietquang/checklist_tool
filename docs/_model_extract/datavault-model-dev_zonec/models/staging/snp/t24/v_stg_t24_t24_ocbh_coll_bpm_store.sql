...
{{ config(
    alias = 'v_stg_t24_t24_ocbh_coll_bpm_store',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_ocbh_coll_bpm_store'),
...
{
    'hashdiff_coll_bpm_store': ['t_txn_status', 't_collateral_id', 't_bpm_trans_id']
}
-%}
