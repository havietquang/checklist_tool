...
{{ config(
    alias = 'v_stg_t24_t24_acct_gen_condition',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('t24_acct_gen_condition'),
...
{% set source_name = 't24' -%}
{% set source_table = "t24_acct_gen_condition" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['id', 't_description', 't_item', 't_priority', 't_value', 't_multivalue', 't_co_code', 't_inputter', 't_date_time', 't_authoriser'] -%}
