...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('fee_discount'),
...
{% set source_table = "fee_discount" -%}
{% set business_key_cols = ['id', 'code'] -%}
{% set list_cols = ['id', 'created_by', 'updated_by', 'code', 'description', 'discount_rate', 'end_at', 'name', 'start_at', 'status', 'fee_discount_type', 'fee_reduction_time', 'approved_by'] -%}
