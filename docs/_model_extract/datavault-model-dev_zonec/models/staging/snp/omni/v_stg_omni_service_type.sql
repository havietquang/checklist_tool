...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('service_type'),
...
{% set source_table = "service_type" -%}
{% set business_key_cols = ['id', 'service_code'] -%}
{% set list_cols = ['id', 'business_function_id', 'maximum_default_transaction_bound', 'minimum_default_transaction_bound', 'service_code', 'service_name', 'support_limit', 'payment_type'] -%}
