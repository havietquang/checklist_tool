...
{{ config(
    alias = 'v_stg_omni_clevertap_tracking',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('clevertap_tracking'),
...
{
    'hashdiff_clevertap_tracking_detail': ['clevertap_id', 'event_name', 'channel', 'created_at', 'modified_at', 'cif']
}
-%}
