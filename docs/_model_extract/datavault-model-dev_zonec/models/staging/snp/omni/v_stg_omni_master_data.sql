...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('master_data'),
...
{% set source_table = "master_data" -%} 
{% set business_key_cols = ['id', 'code'] -%}
{% set list_cols = ['id', 'created_by', 'updated_by', 'code', 'description', 'name', 'status', 'type'] -%}
