...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('message'),
...
{
    'hashdiff_message_information': ['uuid', 'root_message_id', 'subject', 'body', 'is_body_html', 'category', 'important', 'sender', 'sender_name', 'sent_date_time', 'read_receipt', 'deletable', 'read_only', 'content_repo_id', 'content_path', 'metric_dimensions', 'additions', 'recipient']
}
-%}
