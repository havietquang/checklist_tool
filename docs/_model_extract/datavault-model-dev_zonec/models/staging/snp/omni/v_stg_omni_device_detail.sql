...
{{ config(
    alias = 'v_stg_omni_device_detail',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('device_detail'),
...
{
    'hashdiff_device_detail': ['ma_key', 'nfc_enabled', 'omni_version', 'os_version', 'unique_device_id']
}
