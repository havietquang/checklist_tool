...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('voucher'),
                            dung de map dung snapshot/source table.
  - business_key_cols     : Danh sach cot tao thanh Business Key duy nhat
                            cua entity. ['voucher_code']
...
{% set source_table = "voucher" -%} 
{% set business_key_cols = ['voucher_code'] -%}
{% set source_event_date_col = get_source_event_date_col(source_name, source_table, required=true) -%}
{% set hashdiff_satellite_dict =
{
    'hashdiff_voucher_information': ['service_type_code', 'discount_type', 'discount_price', 'discount_percentage', 'max_discount', 'min_price_acceptable', 'refund_liability_account'],
    'hashdiff_voucher_other': ['id', 'created_at', 'updated_at', 'created_by', 'updated_by']
}   
-%}
