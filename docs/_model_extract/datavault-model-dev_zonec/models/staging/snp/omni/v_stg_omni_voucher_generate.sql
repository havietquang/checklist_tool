...
{{ config(
    alias = 'v_stg_omni_voucher_generate',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('voucher_generate'),
                            dung de map dung snapshot/source table.
  - business_key_cols     : Danh sach cot tao thanh Business Key duy nhat
                            cua entity. ['voucher_serial_code']
...
{% set business_key_cols = ['voucher_serial_code'] -%}
{% set source_event_date_col = get_source_event_date_col(source_name, source_table, required=true) -%}
{% set hashdiff_satellite_dict =
{
    'hashdiff_voucher_generate_information': ['status' ,'is_show'],
    'hashdiff_voucher_generate_other': ['id', 'created_at', 'updated_at', 'created_by', 'updated_by']
}   
-%}
