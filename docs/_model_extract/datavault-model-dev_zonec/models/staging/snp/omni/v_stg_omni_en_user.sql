...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('en_user'),
...
{
    'hashdiff_omni_user_information': ['username', 'username_up', 'preferred_language', 'realm_id', 'external_id', 'external_id_up', 'legal_entity_id', 'full_name', 'full_name_up', 'idp_id', 'cb_user_id', 'cb_issuer']
}
-%}
