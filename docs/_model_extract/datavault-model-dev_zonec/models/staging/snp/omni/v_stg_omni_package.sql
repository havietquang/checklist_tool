...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('package'),
...
{% set source_table = "package" -%} 
{% set business_key_cols = ['id', 'code'] -%}
{% set list_cols = ['id', 'created_by', 'updated_by', 'code', 'description', 'name', 'status', 'can_register_ep_portal', 'package_discontinuation_date'] -%}
