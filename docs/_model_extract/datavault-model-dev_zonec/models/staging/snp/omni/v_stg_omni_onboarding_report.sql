...
{{ config(
    alias = 'v_stg_omni_onboarding_report',
    materialized = 'view',
    tags = ['omni', 'onboarding_report', 'phase2', 'phase1', 'all']
) }}
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('onboarding_report'),
...
{% set business_key_cols = ['case_key'] -%}
{% set staging_config = get_staging_config(source_name, source_table) %}
{% set source_event_date_col = staging_config.source_event_date_col %}
{% set source_event_date_dttype = staging_config.source_event_date_dttype %}
{% set hashdiff_satellite_dict =
{
    'hashdiff_onboarding_information': ['step_name', 'report_data', 'phone_number', 'email', 'identity_number', 'full_name', 'created_at', 'modified_at'],
}
-%}
