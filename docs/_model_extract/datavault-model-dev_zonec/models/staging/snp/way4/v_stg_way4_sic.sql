...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('ows_sic'),
...
{% set source_table = "ows_sic" -%}
{% set business_key_cols = ['id' , 'code'] -%}
{% set list_cols = ['amnd_state', 'amnd_date', 'amnd_officer', 'amnd_prev', 'id', 'name', 'code', 'group_code', 'custom_code', 'limit_code', 'sic_group_dflt', 'use_in_bank'] -%}
