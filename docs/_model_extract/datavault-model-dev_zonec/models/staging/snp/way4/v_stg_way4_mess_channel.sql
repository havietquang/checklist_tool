...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('ows_mess_channel'),
...
{% set source_table = "ows_mess_channel" -%}
{% set business_key_cols = ['id' , 'code'] -%}
{% set list_cols = ['amnd_state', 'amnd_date', 'amnd_officer', 'amnd_prev', 'id', 'name', 'code', 'contra_channel', 'data_source', 'is_on_us', 'settl_date'] -%}
