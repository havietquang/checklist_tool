...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('ows_trans_cond'),
...
{% set source_table = "ows_trans_cond" -%}
{% set business_key_cols = ['id' , 'code'] -%}
{% set list_cols = ['amnd_state', 'amnd_date', 'amnd_officer', 'amnd_prev', 'id', 'name', 'code', 'term_cat', 'category_code', 'condition_details', 'default_condition', 'late_condition', 'security_code', 'addendum'] -%}
