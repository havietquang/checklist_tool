...
{{ config(
    alias = 'v_stg_way4_cs_status_type',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('ows_cs_status_type'),
...
{% set source_table = "ows_cs_status_type" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['amnd_date', 'amnd_officer', 'amnd_state', 'amnd_prev', 'id', 'name', 'code', 'group_code', 'default_value', 'applies_to', 'pcat', 'con_cat', 'ccat', 'status_category', 'log_flag', 'is_primary', 'on_off_mode', 'domain_code', 'domain_type__id', 'add_info', 'is_ready'] -%}
