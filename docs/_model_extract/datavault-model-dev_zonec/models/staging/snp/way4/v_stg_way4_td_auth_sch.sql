...
{% set hashdiff_satellite_dict = {
    'hashdiff_td_auth_sch_information': ['auth_idt', 'auth_idt_extension', 'auth_type', 'auth_type_cat', 'auth_type_version_idt', 'name', 'parm_data', 'td_cons__id', 'scheme_rc', 'is_ready', 'date_from', 'date_to', 'apply_dt', 'local_version', 'remote_version', 'client__id', 'acnt_contract__id'],
} -%}
