...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('ows_contr_status'),
...
{% set source_table = "ows_contr_status" -%}
{% set business_key_cols = ['id', 'code'] -%}
{% set list_cols = ['amnd_state', 'amnd_date', 'amnd_officer', 'amnd_prev', 'id', 'con_cat', 'name', 'code', 'external_code', 'is_valid', 'action_type', 'restriction_code', 'priority_code', 'fraud_type', 'auth_rc', 'code_parms'] -%}
