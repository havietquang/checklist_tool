...
{{ config(
    alias = 'v_stg_way4_cs_status_value',
    materialized = 'view',
...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('ows_cs_status_value'),
...
{% set source_table = "ows_cs_status_value" -%}
{% set business_key_cols = ['id'] -%}
{% set list_cols = ['amnd_date', 'amnd_officer', 'amnd_state', 'amnd_prev', 'id', 'cs_status_type__oid', 'status_type_code', 'code', 'name', 'is_ok', 'result_event_code', 'severity_level', 'to_rules', 'from_rules', 'add_info', 'is_active', 'date_from', 'date_to'] -%}
