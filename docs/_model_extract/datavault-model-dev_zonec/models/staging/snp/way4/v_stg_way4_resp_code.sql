...
========================================================================
  ...
  - source_table          : Ten bang nghiep vu nguon ('ows_resp_code'),
                            dung de map dung snapshot/source table.
  - business_key_cols     : Danh sach cot tao thanh Business Key duy nhat
                            cua entity. ['id' , 'resp_code']
...
{% set source_table = "ows_resp_code" -%}
{% set business_key_cols = ['id' , 'resp_code'] -%}
{% set list_cols = ['amnd_state', 'amnd_date', 'amnd_officer', 'amnd_prev', 'id', 'resp_code', 'resp_text', 'resp_level', 'message_code', 'is_status'] -%}
