...
{% set hashdiff_col = 'hashdiff_security_pricing' %}
{% set hub_hashkey = 'security_hashkey' %}
{% set source_model = 'v_stg_t24_t24_security_master' %}
{% set list_cols = ['t_last_price', 't_date_last_price', 't_price_currency', 't_price_type', 't_stk_exch_price', 't_par_value', 't_security_currency'] %}
{% set raw_sql = None %}
