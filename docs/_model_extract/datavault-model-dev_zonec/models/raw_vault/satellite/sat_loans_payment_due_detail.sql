...
{{ config(
    alias = 'sat_loans_payment_due_detail',
...
{% set hashdiff_col = 'hashdiff_loans_payment_due_detail' %}
{% set hub_hashkey = 'loans_payment_due_hashkey' %}
{% set source_model = 'v_stg_t24_t24_payment_due' %}
{% set list_cols = ['t_contract_id', 't_customer', 't_co_code', 't_account_officer'] %}
{% set raw_sql = None %}
