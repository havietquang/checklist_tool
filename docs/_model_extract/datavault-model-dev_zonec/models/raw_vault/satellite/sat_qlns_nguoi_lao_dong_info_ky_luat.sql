...
{{ config(
    alias = 'sat_qlns_nguoi_lao_dong_info_ky_luat',
...
{% set hashdiff_col = 'hashdiff_qlns_nguoi_lao_dong_info_ky_luat' %}
{% set hub_hashkey = 'qlns_nguoi_lao_dong_info_hashkey' %}
{% set source_model = 'v_stg_bpm_qlns_nguoi_lao_dong_info' %}
{% set list_cols = [
    'tinh_trang_ky_luat',
    'ma_tinh_trang_ky_luat',
    'tg_thi_hanh_kl',
    'tg_ket_thuc_thi_hanh_kl',
    'kq_danh_gia_gan_nhat',
    'kqdg_ky_truoc'
] %}
