...
{% set hashdiff_col = 'hashdiff_account_w4_balance' %}
{% set hub_hashkey = 'account_w4_hashkey' %}
{% set source_model = 'v_stg_way4_account' %}
{% set list_cols = ['begin_balance', 'current_balance', 'low_lim_amount', 'upp_lim_amount', 'on_date_balance', 'on_date', 'cycle_date_from', 'cycle_date_to', 'n_of_cycle'] %}
{% set raw_sql = None %}
