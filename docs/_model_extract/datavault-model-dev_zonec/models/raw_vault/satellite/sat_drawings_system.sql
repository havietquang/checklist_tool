...
{% set hashdiff_col = 'hashdiff_drawings_system' %}
{% set hub_hashkey = 'drawings_hashkey' %}
{% set source_model = 'v_stg_t24_t24_drawings' %}
{% set list_cols = ['t_record_status AS t_record_status', 't_inputter AS t_inputter', 't_authoriser AS t_authoriser'] %}
{% set raw_sql = None %}
