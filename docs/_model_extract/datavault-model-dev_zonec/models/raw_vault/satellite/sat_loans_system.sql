...
{% set hashdiff_col = 'hashdiff_loans_system' %}
{% set hub_hashkey = 'loans_hashkey' %}
{% set source_model = 'v_stg_t24_t24_loans_and_deposits' %}
{% set list_cols = ['t_inputter AS t_inputter', 't_authoriser AS t_authoriser', 't_date_time AS t_date_time', 't_curr_no AS t_curr_no'] %}
{% set raw_sql = None %}
