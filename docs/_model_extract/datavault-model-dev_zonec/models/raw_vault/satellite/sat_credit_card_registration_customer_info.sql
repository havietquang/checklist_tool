...
{{ config(
    alias = 'sat_credit_card_registration_customer_info',
...
{% set hashdiff_col = 'hashdiff_credit_card_registration_customer_info' %}
{% set hub_hashkey = 'credit_card_registration_hashkey' %}
{% set source_model = 'v_stg_omni_credit_card_registration' %}
{% set list_cols = ['number_of_dependents', 'job', 'company_address', 'company_address_info', 'company_name', 'type_of_labor_contract', 'position', 'working_time'] %}
{% set raw_sql = None %}
