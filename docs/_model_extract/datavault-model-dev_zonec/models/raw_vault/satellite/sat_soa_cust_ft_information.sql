...
{{ config(
    alias = 'sat_soa_cust_ft_information',
...
{% set hashdiff_col = 'hashdiff_soa_cust_ft_information' %}
{% set hub_hashkey = 'soa_cust_ft_hashkey' %}
{% set source_model = 'v_stg_ocbchannel_soa_cust_ft' %}
{% set list_cols = ['id', 'ft_no', 'serial_no', 'debit_account', 'debit_currency', 'credit_account', 'credit_currency', 'amount', 'payment_details', 'trans_date', 'datetime_created', 'cif', 'branchid', 'status', 'err_message', 'last_updated', 'channel', 'last_access', 'user_created', 'user_approved', 't24_trans_type'] %}
{% set raw_sql = None %}
