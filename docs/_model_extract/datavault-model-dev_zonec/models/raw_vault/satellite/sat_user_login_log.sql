...
{{ config(
    alias = 'sat_user_login_log',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['ocbchannel_user_login_log_hashkey', 'ma_key', 'hashdiff', 'source_event_date'],
    skip_matched_step = true,
    tags = ['ocbchannel', 'user_login_log', 'zonec']
) }}
...
{% set source_table = 'user_login_log' %}
{% set hashdiff_col = 'hashdiff_user_login_log' %}
{% set hub_hashkey = 'ocbchannel_user_login_log_hashkey' %}
{% set source_model = 'v_stg_ocbchannel_user_login_log' %}
{% set list_cols = ['ma_key', 'user_name', 'web_token', 'datetime_login', 'session_status', 'lastdatetime_access', 'channel'] %}
{% set raw_sql = None %}
