...
{{ config(
    alias = 'sat_letter_of_credit_system',
...
{% set hashdiff_col = 'hashdiff_letter_of_credit_system' %}
{% set hub_hashkey = 'letter_of_credit_hashkey' %}
{% set source_model = 'v_stg_t24_t24_letter_of_credit' %}
{% set list_cols = ['t_record_status AS t_record_status', 't_inputter AS t_inputter', 't_authoriser AS t_authoriser', 't_date_time AS t_date_time'] %}
{% set raw_sql = None %}
