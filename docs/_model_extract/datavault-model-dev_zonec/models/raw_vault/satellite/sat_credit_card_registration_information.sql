...
{{ config(
    alias = 'sat_credit_card_registration_information',
...
{% set hashdiff_col = 'hashdiff_credit_card_registration_information' %}
{% set hub_hashkey = 'credit_card_registration_hashkey' %}
{% set source_model = 'v_stg_omni_credit_card_registration' %}
{% set list_cols = ['card_limit_approved', 'created_date', 'updated_date', 'status', 'sale_code', 'personal_rank', 'personal_rank_start', 'personal_rank_renew', 'group_personal_rank', 'card_issuance_type', 'process_type', 'policy_groups'] %}
{% set raw_sql = None %}
