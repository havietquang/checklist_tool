{{ config(
    alias = 'sat_organic_uninstall_events_report_device',
...
{% set hashdiff_col = 'hashdiff_organic_uninstall_events_report_device' %}
{% set hub_hashkey = 'appsflyer_hashkey' %}
{% set source_model = 'v_stg_appsflyer_organic_uninstall_events_report' %}
