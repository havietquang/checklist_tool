...
{{ config(
    alias = 'sat_item_information',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'append',
    unique_key = ['item_hashkey', 'hashdiff', 'source_event_date'],
...
{% set hashdiff_col = 'hashdiff_item_information' %}
{% set hub_hashkey = 'item_hashkey' %}
{% set source_model = 'v_stg_way4_item' %}
{% set list_cols = ['n_of_cycle', 'cycle_template', 'interest_tariff', 'account_number', 'gl_number', 'acc_cycle_code', 'service_class', 'currency', 'cycle_id', 'cycle_date_to', 'cycle_event', 'date_from', 'date_to', 'due_date', 'due_status', 'account__oid', 'templ_approved_id'] %}
{% set raw_sql = None %}
