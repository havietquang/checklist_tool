...
{{ config(
    alias = 'sat_od_registration_limit',
...
{% set hashdiff_col = 'hashdiff_od_registration_limit' %}
{% set hub_hashkey = 'od_registration_hashkey' %}
{% set source_model = 'v_stg_omni_od_registration' %}
{% set list_cols = ['requested_limit_amount AS requested_limit_amount', 'approved_limit_amount AS approved_limit_amount', 'interest_rate AS interest_rate'] %}
{% set raw_sql = None %}
