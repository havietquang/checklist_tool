...
{{ config(
    alias = 'sat_pdtd_nhom_giao_dich_sla',
...
{% set hashdiff_col = 'hashdiff_pdtd_nhom_giao_dich_sla' %}
...
INNER JOIN {{ ref('v_stg_bpm_pdtd_nhom_giao_dich') }} pdtd
    ON sla.gd_id = pdtd.ma_giao_dich
