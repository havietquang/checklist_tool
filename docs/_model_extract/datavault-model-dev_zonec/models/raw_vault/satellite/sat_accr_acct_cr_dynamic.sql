...
{{ config(
    alias = 'sat_accr_acct_cr_dynamic',
...
{% set hashdiff_col = 'hashdiff_accr_acct_cr_dynamic' %}
{% set hub_hashkey = 'account_hashkey' %}
{% set source_model = 'v_stg_t24_t24_accr_acct_cr' %}
{% set list_cols = ['t_period_last_date', 't_int_post_date', 't_cr_no_of_days', 't_cr_int_amt', 't_total_interest', 't_grand_total'] %}
{% set raw_sql = None %}
