...
{% set hashdiff_col = 'hashdiff_acct_officer_other' %}
{% set hub_hashkey = 'dept_acct_officer_hashkey' %}
{% set source_model = 'v_stg_t24_t24_dept_acct_officer' %}
{% set list_cols = ['t_delivery_point','t_restr_to_comps','t_prohibit_comps','t_fax_no','t_telex_no','t_auditor_code','t_audit_date_time','t_dept_level','t_dept_parent','t_alt_dept_level','t_alt_dept_parent','t_mnemonic','t_department','t_accept_message','t_dept_code','t_rm_create_date','t_comp_report','t_cust_group'] %}
{% set raw_sql = None %}
