...
{{ config(
    alias = 'sat_soa_apportion_detail',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['soa_apportion_detail_hashkey', 'hashdiff', 'source_event_date'],
    skip_matched_step = true,
    tags = ['ocbchannel', 'soa_apportion_detail', 'zonec']
) }}
...
{% set source_table = 'soa_apportion_detail' %}
{% set hashdiff_col = 'hashdiff_soa_apportion_detail' %}
{% set hub_hashkey = 'soa_apportion_detail_hashkey' %}
{% set source_model = 'v_stg_ocbchannel_soa_apportion_detail' %}
{% set list_cols = ['department_id', 'apportion_amount'] %}
{% set raw_sql = None %}
