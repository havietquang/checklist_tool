...
{% set hashdiff_col = 'hashdiff_invoice_log_detail' %}
{% set hub_hashkey = 'invoice_log_hashkey' %}
{% set source_model = 'v_stg_way4_invoice_log' %}
{% set list_cols = ['posting_details', 'balance_code', 'creation_type', 'action_code', 'amount_type', 'debt_type', 'sort_code', 'invoice_details', 'invoice_event', 'partition_key', 'creation_date', 'last_updated', 'begin_date', 'end_date'] %}
{% set raw_sql = None %}
