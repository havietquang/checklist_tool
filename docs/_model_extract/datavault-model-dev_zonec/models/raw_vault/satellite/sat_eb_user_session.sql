...
{{ config(
    alias = 'sat_eb_user_session',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['eb_user_session_hashkey', 'ma_key', 'hashdiff', 'source_event_date'],
    skip_matched_step = true,
    tags = ['ocbchannel', 'eb_user_session', 'zonec']
) }}
...
{% set source_table = 'eb_user_session' %}
{% set hashdiff_col = 'hashdiff_eb_user_session' %}
{% set hub_hashkey = 'eb_user_session_hashkey' %}
{% set source_model = 'v_stg_ocbchannel_eb_user_session' %}
{% set list_cols = ['ma_key', 'login_session', 'last_login', 'channel', 'session_expired'] %}
{% set raw_sql = None %}
