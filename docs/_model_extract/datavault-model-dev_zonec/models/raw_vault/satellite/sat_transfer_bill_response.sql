...
{{ config(
    alias = 'sat_transfer_bill_response',
...
{% set hashdiff_col = 'hashdiff_transfer_bill_response' %}
{% set hub_hashkey = 'transfer_bill_hashkey' %}
{% set source_model = 'v_stg_omni_transfer_bill_history' %}
{% set list_cols = ['core_response as core_response', 'core_response_time as core_response_time'] %}
{% set raw_sql = None %}
