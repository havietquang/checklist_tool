...
{{ config(
    alias = 'sat_soa_ntdt_register_bank_account',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['soa_ntdt_register_hashkey', 'ma_key', 'hashdiff', 'source_event_date'],
...
{% set hashdiff_col = 'hashdiff_soa_ntdt_register_bank_account' %}
{% set hub_hashkey = 'soa_ntdt_register_hashkey' %}
{% set source_model = 'v_stg_ocbchannel_soa_ntdt_register_detail' %}
{% set list_cols = ['ma_key', 'bank_account'] %}
{% set raw_sql = None %}
