...
{{ config(
    alias = 'sat_od_registration_date',
...
{% set hashdiff_col = 'hashdiff_od_registration_date' %}
{% set hub_hashkey = 'od_registration_hashkey' %}
{% set source_model = 'v_stg_omni_od_registration' %}
{% set list_cols = ['due_date AS due_date', 'effective_date AS effective_date', 'requested_date AS requested_date', 'issued_date AS issued_date', 'created_at AS created_at', 'updated_at AS updated_at'] %}
{% set raw_sql = None %}
