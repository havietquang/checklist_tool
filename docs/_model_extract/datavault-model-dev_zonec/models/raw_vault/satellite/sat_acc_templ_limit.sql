...
{% set hashdiff_col = 'hashdiff_acc_templ_limit' %}
{% set hub_hashkey = 'acc_templ_hashkey' %}
{% set source_model = 'v_stg_way4_acc_templ' %}
{% set list_cols = ['due_acc_templ', 'alter_due_templ', 'event_type', 'upp_lim_acc_templ', 'low_lim_acc_templ', 'upp_lim_amount', 'low_lim_amount', 'priority', 'ageing_priority', 'offbalance_xf_acc', 'suppl_cr_account', 'suppl_dr_account', 'template_details', 'is_ready'] %}
{% set raw_sql %}
select
    hashkey as acc_templ_hashkey,
    hashdiff_acc_templ_limit as hashdiff,
