...
{% set hashdiff_col = 'hashdiff_usage_action_state' %}
{% set hub_hashkey = 'usage_action_hashkey' %}
{% set source_model = 'v_stg_way4_usage_action' %}
{% set list_cols = ['old_status', 'new_status', 'old_pack', 'new_pack', 'old_scheme', 'new_scheme', 'old_beh_type', 'new_beh_type'] %}
{% set raw_sql = None %}
