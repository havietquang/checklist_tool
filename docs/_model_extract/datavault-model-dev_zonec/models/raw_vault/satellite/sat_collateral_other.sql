...
{% set hashdiff_col = 'hashdiff_collateral_other' %}
{% set hub_hashkey = 'collateral_hashkey' %}
{% set source_model = 'v_stg_t24_t24_collateral' %}
{% set list_cols = ['t_ocb_coll_store AS t_ocb_coll_store', 't_contract_link AS t_contract_link'] %}
{% set raw_sql = None %}
