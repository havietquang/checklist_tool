...
{{ config(
    alias = 'sat_transfer_bill_amount',
...
{% set hashdiff_col = 'hashdiff_transfer_bill_amount' %}
{% set hub_hashkey = 'transfer_bill_hashkey' %}
{% set source_model = 'v_stg_omni_transfer_bill_history' %}
{% set list_cols = ['currency as currency', 'amount as amount', 'amount_per_month as amount_per_month', 'quantity as quantity'] %}
{% set raw_sql = None %}
