...
{% set hashdiff_col = 'hashdiff_teller_other' %}
{% set hub_hashkey = 'teller_hashkey' %}
{% set source_model = 'v_stg_t24_t24_teller' %}
{% set list_cols = ['t_inputter', 't_authoriser', 't_ocb_comp_rece', 't_ocb_class_rece', 't_ocb_class_amt', 't_trans_unique_id', 't_sub_va_id'] %}
{% set raw_sql = None %}
