...
{{ config(
    alias = 'sat_trans_type_mapping',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['trans_type_mapping_hashkey', 'ma_key', 'hashdiff', 'source_event_date'],
    skip_matched_step = true,
    tags = ['ocbchannel', 'trans_type_mapping', 'zonec']
) }}
...
{% set source_table = 'trans_type_mapping' %}
{% set hashdiff_col = 'hashdiff_trans_type_mapping' %}
{% set hub_hashkey = 'trans_type_mapping_hashkey' %}
{% set source_model = 'v_stg_ocbchannel_trans_type_mapping' %}
{% set list_cols = ['ma_key', 'application', 'channel', 'decriptions', 'ofs', 't24_trans_type'] %}
{% set raw_sql = None %}
