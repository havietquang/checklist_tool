...
{{ config(
    alias = 'sat_gl_trace_information',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'append',
    unique_key = ['gl_trace_hashkey', 'hashdiff', 'source_event_date'],
...
{% set source_table = 'ows_gl_trace' %}
{% set hashdiff_col = 'hashdiff_gl_trace_information' %}
{% set hub_hashkey = 'gl_trace_hashkey' %}
{% set source_model = 'v_stg_way4_gl_trace' %}
{% set list_cols = ['curr', 'amount', 'trans_role', 'entry_role', 'gl_doc_id', 'order_date', 'description', 'db_date', 'partition_key', 'gl_transfer__id', 'm_transaction__id', 'cr_main_entry', 'dr_main_entry'] %}
{% set raw_sql = None %}
