...
{% set hashdiff_col = 'hashdiff_forex_rate' %}
{% set hub_hashkey = 'forex_hashkey' %}
{% set source_model = 'v_stg_t24_t24_forex' %}
{% set list_cols = ['t_exch_rate AS t_exch_rate', 't_forward_rate AS t_forward_rate', 't_spot_rate AS t_spot_rate'] %}
{% set raw_sql = None %}
