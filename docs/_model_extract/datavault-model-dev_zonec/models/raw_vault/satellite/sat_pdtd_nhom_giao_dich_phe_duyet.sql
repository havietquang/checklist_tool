...
{{ config(
    alias = 'sat_pdtd_nhom_giao_dich_phe_duyet',
...
{% set hashdiff_col = 'hashdiff_pdtd_nhom_giao_dich_phe_duyet' %}
{% set hub_hashkey = 'pdtd_nhom_giao_dich_hashkey' %}
{% set source_model = 'v_stg_bpm_pdtd_nhom_giao_dich' %}
{% set list_cols = [
    'nguoi_khoi_tao','nguoi_dang_xu_ly','don_vi_kdoanh','cbttd','gdpdtd','don_vi_pduyet','nguoi_phu_trach','bspo_id','cgpddl','cap_phe_duyet_cuoi_id','nhom_khach_hang','loai_nhom_giao_dich','nhom_ho_so','nhom_giao_dich_goc_id','hangkh','rating_id'
] %}
