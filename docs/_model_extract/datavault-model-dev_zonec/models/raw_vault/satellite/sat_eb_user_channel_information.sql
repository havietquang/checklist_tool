...
{{ config(
    alias = 'sat_eb_user_channel_information',
...
{% set hashdiff_col = 'hashdiff_eb_user_channel_information' %}
{% set hub_hashkey = 'eb_user_channel_hashkey' %}
{% set source_model = 'v_stg_ocbchannel_eb_user_channel' %}
{% set list_cols = ['ma_key', 'channel', 'status', 'package_type_id', 'authentication_type', 'branch_code', 'user_created', 'created_date', 'user_authorized'] %}
{% set raw_sql = None %}
