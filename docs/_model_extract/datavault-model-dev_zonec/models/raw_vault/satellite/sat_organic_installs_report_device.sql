{{ config(
    alias = 'sat_organic_installs_report_device',
...
{% set hashdiff_col = 'hashdiff_organic_installs_report_device' %}
{% set hub_hashkey = 'appsflyer_hashkey' %}
{% set source_model = 'v_stg_appsflyer_organic_installs_report' %}
