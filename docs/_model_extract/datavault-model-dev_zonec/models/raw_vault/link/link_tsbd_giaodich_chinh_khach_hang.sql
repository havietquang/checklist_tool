...
*/
{{ config(
    alias = 'link_tsbd_giaodich_chinh_khach_hang',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_tsbd_giaodich_chinh_khach_hang_hashkey'],
...
{% set unique_key = 'link_tsbd_giaodich_chinh_khach_hang_hashkey' %}
