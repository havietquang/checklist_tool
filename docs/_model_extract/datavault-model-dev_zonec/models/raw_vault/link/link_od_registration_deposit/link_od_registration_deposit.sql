...
*/
{{ config(
    alias = 'link_od_registration_deposit',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_od_registration_deposit_hashkey'],
...
{{ link(
    ...
    foreign_business_key_cols = {
        'od_registration_hashkey': ['od_registration_id'],
        'deposit_hashkey': ['deposit_account_no']
    }
) }}
