...
*/
{{ config(
    alias = 'link_customer_related_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_cust_relcust_hashkey'],
...
{% set unique_key = 'link_cust_relcust_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'rel_customer'],
    foreign_business_key_cols = {
        'customer_hashkey': ['id'],
        'related_customer_hashkey': ['rel_customer']
    }
) }}
