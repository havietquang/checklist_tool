...
*/
{{ config(
    alias = 'link_soa_multi_crdr_trans_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_soa_multi_crdr_trans_branch_hashkey'],
...
{% set unique_key = 'link_soa_multi_crdr_trans_branch_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'branchid'],
    foreign_business_key_cols = {
        'soa_multi_crdr_trans_hashkey': ['id'],
        'branch_hashkey': ['branchid']
    }
) }}
