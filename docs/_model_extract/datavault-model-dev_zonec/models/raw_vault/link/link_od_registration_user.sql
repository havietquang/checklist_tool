...
*/
{{ config(
    alias = 'link_od_registration_user',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_od_registration_omni_user_hashkey'],
...
{% set unique_key = 'link_od_registration_omni_user_hashkey' %}
