...
*/
{{ config(
    alias = 'link_transactions_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_transactions_branch_hashkey'],
...
{% set unique_key = 'link_transactions_branch_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['trans_id', 'branch_code'],
    foreign_business_key_cols = {
        'transactions_hashkey': ['trans_id'],
