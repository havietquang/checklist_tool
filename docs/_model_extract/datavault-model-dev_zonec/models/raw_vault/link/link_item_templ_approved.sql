...
*/
{{ config(
    alias = 'link_item_templ_approved',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_item_templ_approved_hashkey'],
...
{% set unique_key = 'link_item_templ_approved_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'templ_approved_id'],
    foreign_business_key_cols = {'item_hashkey': ['id'], 'templ_approved_hashkey': ['templ_approved_id']}
) }}
