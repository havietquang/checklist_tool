...
*/
{{ config(
    alias = 'link_entry_document',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_entry_document_hashkey'],
...
{% set unique_key = 'link_entry_document_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id' , 'doc_id'],
    foreign_business_key_cols = {
        'entry_hashkey': ['id'],
        'document_hashkey': ['doc_id']
    }
) }}
