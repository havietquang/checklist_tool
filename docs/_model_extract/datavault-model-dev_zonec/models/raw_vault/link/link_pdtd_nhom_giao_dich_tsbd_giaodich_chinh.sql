...
*/
{{ config(
    alias = 'link_pdtd_nhom_giao_dich_tsbd_giaodich_chinh',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_pdtd_nhom_giao_dich__tsbd_giaodich_chinh_hashkey'],
...
{% set source_model = 'v_stg_bpm_pdtd_tsbd_link' %}
{% set source_name = 'bpm' %}
{% set source_table = 'pdtd_tsbd_link' %}
{% set unique_key = 'link_pdtd_nhom_giao_dich__tsbd_giaodich_chinh_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['gd_pdtd', 'gd_tsbd'],
    foreign_business_key_cols = {
        'pdtd_nhom_giao_dich_hashkey': ['gd_pdtd'],
        'tsbd_giaodich_chinh_hashkey': ['gd_tsbd']
    }
) }}
