...
*/
{{ config(
    alias = 'link_soa_cust_package_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_soa_cust_package_branch_hashkey'],
...
{% set unique_key = 'link_soa_cust_package_branch_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['package_id', 'branch_code'],
    foreign_business_key_cols = {
        'soa_cust_package_hashkey': ['package_id'],
