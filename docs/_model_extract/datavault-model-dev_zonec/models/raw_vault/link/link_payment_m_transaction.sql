...
*/
{{ config(
    alias = 'link_payment_m_transaction',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_payment_m_transaction_hashkey'],
...
{% set unique_key = 'link_payment_m_transaction_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'm_transaction_id'],
    foreign_business_key_cols = {
        'payment_hashkey': ['id'],
        'm_transaction_hashkey': ['m_transaction_id']
    }
) }}
