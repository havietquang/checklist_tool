...
*/
{{ config(
    alias = 'link_soa_ntdt_register_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_soa_ntdt_register_branch_hashkey'],
...
{% set unique_key = 'link_soa_ntdt_register_branch_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'branch_code'],
    foreign_business_key_cols = {
        'soa_ntdt_register_hashkey': ['id'],
