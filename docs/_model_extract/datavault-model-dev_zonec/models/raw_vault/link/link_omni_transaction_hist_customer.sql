...
*/
{{ config(
    alias = 'link_omni_transaction_hist_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_omni_transaction_hist_customer_hashkey'],
...
{% set unique_key = 'link_omni_transaction_hist_customer_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['trans_id', 'cif'],
    foreign_business_key_cols = {
        'omni_transaction_hist_hashkey': ['trans_id'],
