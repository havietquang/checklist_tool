...
*/
{{ config(
    alias = 'link_repo_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_repo_customer_hashkey'],
...
{% set unique_key = 'link_repo_customer_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'counterparty'],
    foreign_business_key_cols = {
        'repo_hashkey': ['id'],
        'customer_hashkey': ['counterparty']
    }
) }}
