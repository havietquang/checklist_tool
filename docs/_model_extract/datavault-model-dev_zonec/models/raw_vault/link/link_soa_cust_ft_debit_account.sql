...
*/
{{ config(
    alias = 'link_soa_cust_ft_debit_account',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_soa_cust_ft_debit_account_hashkey'],
...
DEBIT_ACCOUNT NOT LIKE 'PL%' (loai tai khoan noi bo PL).
*/
{%- set raw_sql -%}
SELECT
    {{ hash_column(['id', 'debit_account'], source_name) }} AS link_soa_cust_ft_debit_account_hashkey,
