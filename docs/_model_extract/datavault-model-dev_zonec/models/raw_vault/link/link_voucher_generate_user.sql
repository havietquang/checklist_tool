...
*/
{{ config(
    alias = 'link_voucher_generate_user',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_voucher_generate_omni_user_hashkey'],
...
{% set unique_key = 'link_voucher_generate_omni_user_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['voucher_serial_code', 'user_id'],
