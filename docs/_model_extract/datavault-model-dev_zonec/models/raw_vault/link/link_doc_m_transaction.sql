...
*/
{{ config(
    alias = 'link_doc_m_transaction',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_doc_m_transaction_hashkey'],
...
{% set unique_key = 'link_doc_m_transaction_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['ID', 'DOC__OID'],
    foreign_business_key_cols = {
        'm_transaction_hashkey': ['ID'],
        'document_hashkey': ['DOC__OID']
    }
) }}
