...
*/
{{ config(
    alias = 'link_admin_command_queue_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_admin_command_queue_branch_hashkey'],
...
{% set unique_key = 'link_admin_command_queue_branch_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['command_id', 'branch_code'],
    foreign_business_key_cols = {
        'admin_command_queue_hashkey': ['command_id'],
