...
*/
{{ config(
    alias = 'link_collateral_man_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_collateral_man_branch_hashkey'],
...
{% set unique_key = 'link_collateral_man_branch_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 't_man_comp_id'],
    foreign_business_key_cols = {
        'collateral_hashkey': ['id'],
        'branch_hashkey': ['t_man_comp_id']
    }
) }}
