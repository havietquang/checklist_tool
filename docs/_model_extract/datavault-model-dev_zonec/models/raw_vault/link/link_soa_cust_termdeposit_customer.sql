...
*/
{{ config(
    alias = 'link_soa_cust_termdeposit_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_soa_cust_termdeposit_customer_hashkey'],
...
{% set unique_key = 'link_soa_cust_termdeposit_customer_hashkey' %}
