...
*/
{{ config(
    alias = 'link_line_movement_toanhang_stmt_entry',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'append',
    unique_key = ['link_line_movement_toanhang_stmt_entry_hashkey'],
...
{% set unique_key = 'link_line_movement_toanhang_stmt_entry_hashkey' %}
...
{%- set raw_sql -%}
SELECT DISTINCT
    {{ hash_column(['t_line_id', 't_stt', 't_y_key_det'], source_name) }} AS link_line_movement_toanhang_stmt_entry_hashkey,
    {{ hash_column(['t_line_id', 't_stt'], source_name) }} AS line_movement_toanhang_hashkey,
    {{ hash_column(['t_y_key_det'], source_name) }} AS stmt_entry_hashkey,
    source_event_date,
