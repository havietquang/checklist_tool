...
*/
{{ config(
    alias = 'link_crm_users_dept_acct_officer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_crm_users_dept_acct_officer_hashkey'],
...
{% set unique_key = 'link_crm_users_dept_acct_officer_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['user_id', 'account_officer_id'],
    foreign_business_key_cols = {
        'crm_users_hashkey': ['user_id'],
        'dept_acct_officer_hashkey': ['account_officer_id']
    }
) }}
