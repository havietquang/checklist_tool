...
*/
{{ config(
    alias = 'link_onbroading_cus_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_onbroading_cus_customer_hashkey'],
...
{% set unique_key = 'link_onbroading_cus_customer_hashkey' %}
