...
*/
{{ config(
    alias = 'link_eb_users_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_eb_users_customer_hashkey'],
...
{% set unique_key = 'link_eb_users_customer_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['user_id', 'cif'],
    foreign_business_key_cols = {
        'eb_users_hashkey': ['user_id'],
