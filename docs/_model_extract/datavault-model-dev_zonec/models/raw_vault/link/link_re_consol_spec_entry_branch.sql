...
*/
{{ config(
    alias = 'link_re_consol_spec_entry_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_re_consol_spec_entry_branch_hashkey'],
...
{% set unique_key = 'link_re_consol_spec_entry_branch_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id','t_company_code'],
    foreign_business_key_cols = {
        're_consol_spec_entry_hashkey': ['id'],
        'branch_hashkey': ['t_company_code']
    }
) }}
