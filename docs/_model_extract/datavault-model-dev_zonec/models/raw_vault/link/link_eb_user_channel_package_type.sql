...
*/
{{ config(
    alias = 'link_eb_user_channel_package_type',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_eb_user_channel_package_type_hashkey'],
...
{% set unique_key = 'link_eb_user_channel_package_type_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['user_id', 'package_type_id'],
    foreign_business_key_cols = {
        'eb_user_channel_hashkey': ['user_id'],
        'eb_package_type_hashkey': ['package_type_id']
    }
) }}
