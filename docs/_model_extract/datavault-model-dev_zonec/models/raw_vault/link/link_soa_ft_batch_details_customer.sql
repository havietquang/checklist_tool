...
*/
{{ config(
    alias = 'link_soa_ft_batch_details_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_soa_ft_batch_details_customer_hashkey'],
...
{% set unique_key = 'link_soa_ft_batch_details_customer_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['batch_id', 'cif'],
