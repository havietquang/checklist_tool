...
*/
{{ config(
    alias = 'link_soa_thq_register_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_soa_thq_register_branch_hashkey'],
...
{% set unique_key = 'link_soa_thq_register_branch_hashkey' %}
