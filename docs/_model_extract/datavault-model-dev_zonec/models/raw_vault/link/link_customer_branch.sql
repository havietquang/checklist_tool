...
*/
{{ config(
    alias = 'link_customer_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_customer_branch_hashkey'],
...
{% set unique_key = 'link_customer_branch_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'company_book'],
    foreign_business_key_cols = {
        'customer_hashkey': ['id'],
        'branch_hashkey': ['company_book']
    }
) }}
