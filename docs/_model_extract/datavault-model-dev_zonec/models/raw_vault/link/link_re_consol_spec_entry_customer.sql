...
*/
{{ config(
    alias = 'link_re_consol_spec_entry_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_re_consol_spec_entry_customer_hashkey'],
...
{% set unique_key = 'link_re_consol_spec_entry_customer_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id','t_customer_id'],
    foreign_business_key_cols = {
        're_consol_spec_entry_hashkey': ['id'],
        'customer_hashkey': ['t_customer_id']
    }
) }}
