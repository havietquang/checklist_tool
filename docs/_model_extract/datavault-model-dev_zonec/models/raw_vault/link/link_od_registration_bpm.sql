...
*/
{{ config(
    alias = 'link_od_registration_bpm',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_od_registration_bpm_hashkey'],
...
{% set unique_key = 'link_od_registration_bpm_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'bpm_id'],
    foreign_business_key_cols = {
        'od_registration_hashkey': ['id'],
        'giao_dich_hashkey': ['bpm_id']
    }
) }}
