...
*/
{{ config(
    alias = 'link_soa_cust_package_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_soa_cust_package_customer_hashkey'],
...
{% set unique_key = 'link_soa_cust_package_customer_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['package_id', 'cif'],
