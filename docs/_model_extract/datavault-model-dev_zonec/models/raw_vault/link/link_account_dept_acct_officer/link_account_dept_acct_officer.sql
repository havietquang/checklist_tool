...
*/
{{ config(
    alias = 'link_account_dept_acct_officer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_account_dept_acct_officer_hashkey'],
...
{% set raw_sql -%}
SELECT
    {{ hash_column(['id', 't_account_officer'], source_name) }} AS {{ unique_key }},
    {{ hash_column(['id'], source_name) }} AS account_hashkey,
    {{ hash_column(['t_account_officer'], source_name) }} AS dept_acct_officer_hashkey,
