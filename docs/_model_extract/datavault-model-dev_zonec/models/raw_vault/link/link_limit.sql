...
{% set unique_key = 'link_limit_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['t_record_parent', 'id'],
    foreign_business_key_cols = {
        'limit_parent_hashkey': ['t_record_parent'],
        'limit_child_hashkey': ['id']
    }
) }}
