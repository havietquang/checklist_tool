...
*/
{{ config(
    alias = 'link_soa_multi_crdr_trans_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_soa_multi_crdr_trans_customer_hashkey'],
...
{% set unique_key = 'link_soa_multi_crdr_trans_customer_hashkey' %}
