...
*/
{{ config(
    alias = 'link_contact_hist_contact_notes',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_contact_hist_contact_notes_hashkey'],
...
{% set unique_key = 'link_contact_hist_contact_notes_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'contactnoteid'],
    foreign_business_key_cols = {
        'crm_contact_hist_hashkey': ['id'],
        'crm_contact_notes_hashkey': ['contactnoteid']
    }
) }}
