...
*/
{{ config(
    alias = 'link_oversea_ft_request_forex',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_oversea_ft_request_forex_hashkey'],
...
{% set unique_key = 'link_oversea_ft_request_forex_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['ID', 'ft_reference'],
    foreign_business_key_cols = {
        'oversea_ft_request_hashkey': ['ID'],
        'forex_hashkey': ['ft_reference']
    }
) }}
