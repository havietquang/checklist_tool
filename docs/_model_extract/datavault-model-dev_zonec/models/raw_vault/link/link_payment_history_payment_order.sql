...
*/
{{ config(
    alias = 'link_payment_history_payment_order',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_payment_history_payment_order_hashkey'],
...
{% set unique_key = 'link_payment_history_payment_order_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'payment_order_id'],
    foreign_business_key_cols = {
        'payment_history_hashkey': ['id'],
        'payment_order_hashkey': ['payment_order_id']
    }
) }}
