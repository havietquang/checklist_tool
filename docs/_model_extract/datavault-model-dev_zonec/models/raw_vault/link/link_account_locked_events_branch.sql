...
*/
{{ config(
    alias = 'link_account_locked_events_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_account_locked_events_branch_hashkey'],
...
{% set unique_key = 'link_account_locked_events_branch_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['ID', 'T_CO_CODE'],
    foreign_business_key_cols = {
        'ac_locked_events_hashkey': ['ID'],
        'branch_hashkey': ['T_CO_CODE']
    }
) }}
