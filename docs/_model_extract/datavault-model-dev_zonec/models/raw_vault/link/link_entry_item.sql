...
*/
{{ config(
    alias = 'link_entry_item',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_entry_item_hashkey'],
...
{% set unique_key = 'link_entry_item_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'item__id'],
    foreign_business_key_cols = {'entry_hashkey': ['id'], 'item_hashkey': ['item__id']}
) }}
