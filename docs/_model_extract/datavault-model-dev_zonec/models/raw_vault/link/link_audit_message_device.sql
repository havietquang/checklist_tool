...
*/
{{ config(
    alias = 'link_audit_message_device',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_audit_message_device_hashkey'],
...
{% set unique_key = 'link_audit_message_device_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'device_id'],
