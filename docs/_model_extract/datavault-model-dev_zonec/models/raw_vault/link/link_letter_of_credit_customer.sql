...
*/
{{ config(
    alias = 'link_letter_of_credit_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_letter_of_credit_customer_hashkey'],
...
{% set unique_key = 'link_letter_of_credit_customer_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 't_applicant_custno'],
    foreign_business_key_cols = {
        'letter_of_credit_hashkey': ['id'],
        'customer_hashkey': ['t_applicant_custno']
    }
) }}
