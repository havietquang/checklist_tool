...
*/
{{ config(
    alias = 'link_oversea_ft_request_account',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_oversea_ft_request_account_hashkey'],
...
{% set unique_key = 'link_oversea_ft_request_account_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['ID', 'account_number'],
    foreign_business_key_cols = {
        'oversea_ft_request_hashkey': ['ID'],
        'account_hashkey': ['account_number']
    }
) }}
