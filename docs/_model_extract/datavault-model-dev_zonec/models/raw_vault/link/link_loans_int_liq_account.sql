...
*/
{{ config(
    alias = 'link_loans_int_liq_account',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_loans_int_liq_account_hashkey'],
...
{% set unique_key = 'link_loans_int_liq_account_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 't_int_liq_acct'],
    foreign_business_key_cols = {
        'loans_hashkey': ['id'],
        'account_hashkey': ['t_int_liq_acct']
    }
) }}
