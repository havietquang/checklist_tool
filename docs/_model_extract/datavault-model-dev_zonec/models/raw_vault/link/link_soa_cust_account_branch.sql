...
*/
{{ config(
    alias = 'link_soa_cust_account_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_soa_cust_account_branch_hashkey'],
...
{% set unique_key = 'link_soa_cust_account_branch_hashkey' %}
