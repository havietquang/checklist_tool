...
*/
{{ config(
    alias = 'link_account_locked_events_account',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_account_locked_events_account_hashkey'],
...
{% set unique_key = 'link_account_locked_events_account_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['ID', 'T_ACCOUNT_NUMBER'],
    foreign_business_key_cols = {
        'ac_locked_events_hashkey': ['ID'],
        'account_hashkey': ['T_ACCOUNT_NUMBER']
    }
) }}
