...
*/
{{ config(
    alias = 'link_khach_hang_cif_t24',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_khach_hang_customer_hashkey'],
...
{% set unique_key = 'link_khach_hang_customer_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'so_cif'],
    foreign_business_key_cols = {
        'khach_hang_hashkey': ['id'],
        'customer_hashkey': ['so_cif']
    }
) }}
