...
*/
{{ config(
    alias = 'link_diary_security',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_diary_security_hashkey'],
...
{% set unique_key = 'link_diary_security_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 't_security_no'],
    foreign_business_key_cols = {
        'diary_hashkey': ['id'],
        'security_hashkey': ['t_security_no']
    }
) }}
