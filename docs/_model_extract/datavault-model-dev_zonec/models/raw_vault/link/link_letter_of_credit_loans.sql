...
*/
{{ config(
    alias = 'link_letter_of_credit_loans',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_letter_of_credit_loans_hashkey'],
...
{% set unique_key = 'link_letter_of_credit_loans_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 't_link_ld_ref'],
    foreign_business_key_cols = {
        'letter_of_credit_hashkey': ['id'],
        'loans_hashkey': ['t_link_ld_ref']
    }
) }}
