...
*/
{{ config(
    alias = 'link_stmt_entry_officer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_stmt_entry_officer_hashkey'],
...
{% set unique_key = 'link_stmt_entry_officer_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['t_account_officer', 'id'],
