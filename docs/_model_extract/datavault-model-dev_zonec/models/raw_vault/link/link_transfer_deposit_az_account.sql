...
*/
{{ config(
    alias = 'link_transfer_deposit_az_account',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_transfer_deposit_az_account_hashkey'],
...
{% set unique_key = 'link_transfer_deposit_az_account_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'az_number'],
    foreign_business_key_cols = {
        'transfer_deposit_hashkey': ['id'],
        'deposit_hashkey': ['az_number']
    }
) }}
