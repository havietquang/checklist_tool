...
*/
{{ config(
    alias = 'link_soa_hdtg_da_nang_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_soa_hdtg_da_nang_branch_hashkey'],
...
{% set unique_key = 'link_soa_hdtg_da_nang_branch_hashkey' %}
