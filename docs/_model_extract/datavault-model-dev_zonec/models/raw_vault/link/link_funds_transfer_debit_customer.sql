...
*/
{{ config(
    alias = 'link_funds_transfer_debit_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_funds_transfer_debit_customer_hashkey'],
...
{% set unique_key = 'link_funds_transfer_debit_customer_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['t_debit_customer', 'id'],
