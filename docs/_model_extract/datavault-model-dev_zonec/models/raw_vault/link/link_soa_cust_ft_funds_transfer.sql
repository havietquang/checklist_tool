...
*/
{{ config(
    alias = 'link_soa_cust_ft_funds_transfer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_soa_cust_ft_funds_transfer_hashkey'],
...
{% set unique_key = 'link_soa_cust_ft_funds_transfer_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'ft_no'],
    foreign_business_key_cols = {
        'soa_cust_ft_hashkey': ['id'],
        'funds_transfer_hashkey': ['ft_no']
    }
) }}
