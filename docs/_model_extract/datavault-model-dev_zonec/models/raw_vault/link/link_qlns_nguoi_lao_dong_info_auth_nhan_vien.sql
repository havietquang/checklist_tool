...
*/
{{ config(
    alias = 'link_qlns_nguoi_lao_dong_info_auth_nhan_vien',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_qlns_nguoi_lao_dong_info_auth_nhan_vien_hashkey'],
...
{% set unique_key = 'link_qlns_nguoi_lao_dong_info_auth_nhan_vien_hashkey' %}
{% set raw_sql = None %}
/*  
...
{{ link(
    ...
    source_business_key_cols = ['ma_nhan_vien', 'ten_dang_nhap'],
    foreign_business_key_cols = {
        'qlns_nguoi_lao_dong_info_hashkey': ['ma_nhan_vien'],
        'auth_nhan_vien_hashkey': ['ten_dang_nhap']
    }
) }}
