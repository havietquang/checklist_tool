...
*/
{{ config(
    alias = 'link_deposits_nominated_account',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_deposits_nominated_account_hashkey'],
...
{% set unique_key = 'link_deposits_nominated_account_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 't_nominated_account'],
    foreign_business_key_cols = {
        'deposit_hashkey': ['id'],
        'account_hashkey': ['t_nominated_account']
    }
) }}
