...
*/
{{ config(
    alias = 'link_batch_trans_detail_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_batch_trans_detail_customer_hashkey'],
...
{% set unique_key = 'link_batch_trans_detail_customer_hashkey' %}
...
{{ link(
    ...
    foreign_business_key_cols = {
        'batch_trans_details_hashkey': ['batch_id'],
