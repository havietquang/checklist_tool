...
*/
{{ config(
    alias = 'link_teller_customer1',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_teller_customer1_hashkey'],
...
{% set unique_key = 'link_teller_customer1_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['t_customer_1', 'id'],
    foreign_business_key_cols = {
        'teller_hashkey': ['id'],
        'customer_hashkey': ['t_customer_1']
    }
) }}
