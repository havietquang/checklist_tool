...
*/
{{ config(
    alias = 'link_device_user',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_device_user_hashkey'],
    skip_matched_step = true,
    tags = ['omni', 'device', 'phase1', 'all']
) }}
...
{% set unique_key = 'link_device_user_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['device_id', 'user_id'],
    foreign_business_key_cols = {
        'device_omni_hashkey': ['device_id'],
