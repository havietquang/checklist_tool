...
*/
{{ config(
    alias = 'link_gl_trace_debit_entry',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_gl_trace_debit_entry_hashkey'],
...
{% set unique_key = 'link_gl_trace_debit_entry_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'dr_main_entry'],
    foreign_business_key_cols = {'gl_trace_hashkey': ['id'], 'entry_hashkey': ['dr_main_entry']}
) }}
