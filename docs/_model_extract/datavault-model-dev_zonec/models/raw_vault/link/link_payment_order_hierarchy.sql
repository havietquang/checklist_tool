...
*/
{{ config(
    alias = 'link_payment_order_hierarchy',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_payment_order_hashkey'],
...
{% set unique_key = 'link_payment_order_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'parent_payment_id'],
    foreign_business_key_cols = {
        'payment_order_hashkey': ['id'],
        'parent_payment_order_hashkey': ['parent_payment_id']
    }
) }}
