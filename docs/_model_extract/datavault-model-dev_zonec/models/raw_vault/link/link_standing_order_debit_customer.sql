...
*/
{{ config(
    alias = 'link_standing_order_debit_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_standing_order_debit_customer_hashkey'],
...
{% set unique_key = 'link_standing_order_debit_customer_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 't_debit_customer'],
    foreign_business_key_cols = {
        'standing_order_hashkey': ['id'],
        'customer_hashkey': ['t_debit_customer']
    }
) }}
