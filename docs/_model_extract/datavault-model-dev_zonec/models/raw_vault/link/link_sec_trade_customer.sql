...
*/
{{ config(
    alias = 'link_sec_trade_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_sec_trade_customer_hashkey'],
...
{% set unique_key = 'link_sec_trade_customer_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'customer_no'],
