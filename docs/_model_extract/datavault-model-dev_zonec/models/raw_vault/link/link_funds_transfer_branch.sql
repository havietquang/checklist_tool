...
*/
{{ config(
    alias = 'link_funds_transfer_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_funds_transfer_branch_hashkey'],
...
{% set unique_key = 'link_funds_transfer_branch_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['t_co_code', 'id'],
