...
*/
{{ config(
    alias = 'link_funds_transfer_credit_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_funds_transfer_credit_customer_hashkey'],
...
{% set unique_key = 'link_funds_transfer_credit_customer_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['t_credit_customer', 'id'],
    foreign_business_key_cols = {
        'funds_transfer_hashkey': ['id'],
        'customer_hashkey': ['t_credit_customer']
    }
) }}
