...
*/
{{ config(
    alias = 'link_transfer_deposit_acct_officer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_transfer_deposit_acct_officer_hashkey'],
...
{{ link(
    ...
    foreign_business_key_cols = {
        'transfer_deposit_hashkey': ['id'],
        'dept_acct_officer_hashkey': ['rm_code']
    }
) }}
