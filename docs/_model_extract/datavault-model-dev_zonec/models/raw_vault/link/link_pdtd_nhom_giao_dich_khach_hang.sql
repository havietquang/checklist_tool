...
*/
{{ config(
    alias = 'link_pdtd_nhom_giao_dich_khach_hang',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_pdtd_nhom_giao_dich_khach_hang_hashkey'],
...
{% set unique_key = 'link_pdtd_nhom_giao_dich_khach_hang_hashkey' %}
...
{{ link(
    ...
    foreign_business_key_cols = {
        'pdtd_nhom_giao_dich_hashkey': ['ma_giao_dich'],
        'khach_hang_hashkey': ['khach_hang_id']
    }
) }}
