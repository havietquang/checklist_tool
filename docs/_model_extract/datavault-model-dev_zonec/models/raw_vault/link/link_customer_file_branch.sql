...
*/
{{ config(
    alias = 'link_customer_file_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_customer_file_branch_hashkey'],
...
{% set unique_key = 'link_customer_file_branch_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'cif_branch_code'],
    foreign_business_key_cols = {
        'customer_file_hashkey': ['id'],
        'branch_hashkey': ['cif_branch_code']
    }
) }}
