...
*/
{{ config(
    alias = 'link_sec_trade_security',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_sec_trade_security_hashkey'],
...
{% set unique_key = 'link_sec_trade_security_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'security_code'],
    foreign_business_key_cols = {
        'sec_trade_hashkey': ['id'],
        'security_hashkey': ['security_code']
    }
) }}
