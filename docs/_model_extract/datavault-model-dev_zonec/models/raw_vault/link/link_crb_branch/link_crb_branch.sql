...
*/
{{ config(
    alias = 'link_crb_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_crb_branch_hashkey'],
...
{% set source_business_key_cols = ['tieukhoan', 'gl', 'chinhanh'] %}
{% set crb_business_key_cols = ['tieukhoan', 'gl'] %}
{% set branch_business_key_cols = ['chinhanh'] %}
...
{% set raw_sql -%}
SELECT DISTINCT
    {{ hash_column(source_business_key_cols,source_name) }} AS link_crb_branch_hashkey,
    {{ hash_column(crb_business_key_cols,source_name) }} AS crb_hashkey,
    {{ hash_column(branch_business_key_cols,source_name) }} AS branch_hashkey,
