...
*/
{{ config(
    alias = 'link_forex_customer',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_forex_customer_hashkey'],
...
{% set unique_key = 'link_forex_customer_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 't_counterparty'],
    foreign_business_key_cols = {
        'forex_hashkey': ['id'],
        'customer_hashkey': ['t_counterparty']
    }
) }}
