...
*/
{{ config(
    alias = 'link_oversea_ft_request_user',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_oversea_ft_request_omni_user_hashkey'],
...
{% set unique_key = 'link_oversea_ft_request_omni_user_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['ID', 'USER_ID'],
    foreign_business_key_cols = {
        'oversea_ft_request_hashkey': ['ID'],
        'omni_user_hashkey': ['USER_ID']
    }
) }}
