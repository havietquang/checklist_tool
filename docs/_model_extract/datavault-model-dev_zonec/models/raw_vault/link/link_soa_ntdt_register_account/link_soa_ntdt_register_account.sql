...
*/
{{ config(
    alias = 'link_soa_ntdt_register_account',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_soa_ntdt_register_account_hashkey'],
...
{{ link(
    ...
    source_business_key_cols = ['register_id', 'bank_account'],
    foreign_business_key_cols = {
        'soa_ntdt_register_hashkey': ['register_id'],
        'account_hashkey': ['bank_account']
    }
) }}
