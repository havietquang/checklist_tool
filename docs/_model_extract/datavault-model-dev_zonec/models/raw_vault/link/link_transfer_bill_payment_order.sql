...
*/
{{ config(
    alias = 'link_transfer_bill_payment_order',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_transfer_bill_payment_order_hashkey'],
...
{% set unique_key = 'link_transfer_bill_payment_order_hashkey' %}
