...
*/
{{ config(
    alias = 'link_funds_transfer_clearing_citad',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_funds_transfer_clearing_citad_hashkey'],
...
{% set unique_key = 'link_funds_transfer_clearing_citad_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 't_clearing_id'],
    foreign_business_key_cols = {
        'funds_transfer_hashkey': ['id'],
        'clearing_citad_hashkey': ['t_clearing_id']
    }
) }}
