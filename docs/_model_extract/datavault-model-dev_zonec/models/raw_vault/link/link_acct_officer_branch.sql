...
*/
{{ config(
    alias = 'link_acct_officer_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_dept_acct_officer_branch_hashkey'],
...
{% set unique_key = 'link_dept_acct_officer_branch_hashkey' %}
