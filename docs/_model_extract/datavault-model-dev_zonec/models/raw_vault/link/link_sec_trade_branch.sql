...
*/
{{ config(
    alias = 'link_sec_trade_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_sec_trade_branch_hashkey'],
...
{% set unique_key = 'link_sec_trade_branch_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'co_code'],
    foreign_business_key_cols = {
        'sec_trade_hashkey': ['id'],
        'branch_hashkey': ['co_code']
    }
) }}
