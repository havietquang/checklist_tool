...
*/
{{ config(
    alias = 'link_audit_message_user',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_audit_message_user_hashkey'],
...
{% set unique_key = 'link_audit_message_user_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'actor_user_id'],
    foreign_business_key_cols = {
        'audit_message_hashkey': ['id'],
        'omni_user_hashkey': ['actor_user_id']
    }
) }}
