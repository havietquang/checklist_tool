...
*/
{{ config(
    alias = 'link_giao_dich_khach_hang',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_giao_dich_khach_hang_hashkey'],
...
{% set unique_key = 'link_giao_dich_khach_hang_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['gd_id', 'khach_hang_id'],
