...
*/
{{ config(
    alias = 'link_ocb_bill_service_provider',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_ocb_bill_service_provider_hashkey'],
...
{% set unique_key = 'link_ocb_bill_service_provider_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['service_id', 'provider_id'],
    foreign_business_key_cols = {
        'ocb_bill_services_hashkey': ['service_id'],
        'ocb_bill_providers_hashkey': ['provider_id']
    }
) }}
