...
*/
{{ config(
    alias = 'link_user_account',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_user_account_hashkey'],
...
{% set unique_key = 'link_user_account_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 't_account'],
    foreign_business_key_cols = {
        'user_hashkey': ['id'],
        'account_hashkey': ['t_account']
    }
) }}
