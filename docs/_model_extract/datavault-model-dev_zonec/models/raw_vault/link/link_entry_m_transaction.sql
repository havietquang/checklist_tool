...
*/
{{ config(
    alias = 'link_entry_m_transaction',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_entry_m_transaction_hashkey'],
...
{% set unique_key = 'link_entry_m_transaction_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id' , 'm_transaction__id'],
    foreign_business_key_cols = {
        'entry_hashkey': ['id'],
        'm_transaction_hashkey': ['m_transaction__id']
    }
) }}
