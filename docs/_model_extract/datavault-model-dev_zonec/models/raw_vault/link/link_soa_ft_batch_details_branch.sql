...
*/
{{ config(
    alias = 'link_soa_ft_batch_details_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_soa_ft_batch_details_branch_hashkey'],
...
{% set unique_key = 'link_soa_ft_batch_details_branch_hashkey' %}
...
{{ link(
    ...
    foreign_business_key_cols = {
        'soa_ft_batch_details_hashkey': ['batch_id'],
