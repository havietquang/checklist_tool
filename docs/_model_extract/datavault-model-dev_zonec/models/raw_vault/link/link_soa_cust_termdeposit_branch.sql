...
*/
{{ config(
    alias = 'link_soa_cust_termdeposit_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_soa_cust_termdeposit_branch_hashkey'],
...
{% set unique_key = 'link_soa_cust_termdeposit_branch_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 'branch_id'],
    foreign_business_key_cols = {
        'soa_cust_termdeposit_hashkey': ['id'],
        'branch_hashkey': ['branch_id']
    }
) }}
