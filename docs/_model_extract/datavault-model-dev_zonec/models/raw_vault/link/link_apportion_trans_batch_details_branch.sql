...
*/
{{ config(
    alias = 'link_apportion_trans_batch_details_branch',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_apportion_trans_batch_details_branch_hashkey'],
...
{% set unique_key = 'link_apportion_trans_batch_details_branch_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['batch_id', 'branch_code'],
    foreign_business_key_cols = {
        'apportion_trans_batch_details_hashkey': ['batch_id'],
