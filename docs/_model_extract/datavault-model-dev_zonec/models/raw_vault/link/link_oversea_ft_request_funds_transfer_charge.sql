...
*/
{{ config(
    alias = 'link_oversea_ft_request_funds_transfer_charge',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_oversea_ft_request_funds_transfer_charge_hashkey'],
...
{% set unique_key = 'link_oversea_ft_request_funds_transfer_charge_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['ID', 'charge_reference'],
    foreign_business_key_cols = {
        'oversea_ft_request_hashkey': ['ID'],
        'funds_transfer_hashkey': ['charge_reference']
    }
) }}
