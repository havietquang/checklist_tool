...
*/
{{ config(
    alias = 'link_security_block_security',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_security_block_security_hashkey'],
...
{% set unique_key = 'link_security_block_security_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 't_security_code'],
    foreign_business_key_cols = {
        'security_block_hashkey': ['id'],
        'security_hashkey': ['t_security_code']
    }
) }}
