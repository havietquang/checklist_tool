...
*/
{{ config(
    alias = 'link_soa_multi_crdr_trans_debit_account',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_soa_multi_crdr_trans_debit_account_hashkey'],
...
DEBIT_ACCOUNT_1..4 thanh mot cot debit_account, va loc:
...
SELECT
    ...
    {{ hash_column(['debit_account'], source_name) }} AS account_hashkey,
