...
*/
{{ config(
    alias = 'link_loans_prin_liq_account',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_loans_prin_liq_account_hashkey'],
...
{% set unique_key = 'link_loans_prin_liq_account_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 't_prin_liq_acct'],
    foreign_business_key_cols = {
        'loans_hashkey': ['id'],
        'account_hashkey': ['t_prin_liq_acct']
    }
) }}
