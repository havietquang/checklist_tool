...
*/
{{ config(
    alias = 'link_loans_fee_pay_account',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['link_loans_fee_pay_account_hashkey'],
...
{% set unique_key = 'link_loans_fee_pay_account_hashkey' %}
...
{{ link(
    ...
    source_business_key_cols = ['id', 't_fee_pay_account'],
    foreign_business_key_cols = {
        'loans_hashkey': ['id'],
        'fee_pay_account_hashkey': ['t_fee_pay_account']
    }
) }}
