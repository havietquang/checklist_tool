{{ config(
    alias = 'effsat_link_loans_dept_acct_officer_nvgt',
    materialized = 'incremental_checkpoint',
    unique_key = ['link_loans_dept_acct_officer_nvgt_hashkey', 'source_event_date'],
...
{{ effsat(
    ...
    link_model = 'link_loans_dept_acct_officer_nvgt'
) }}
