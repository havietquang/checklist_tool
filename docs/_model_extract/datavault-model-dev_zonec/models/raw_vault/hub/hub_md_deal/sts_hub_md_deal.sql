-- depends_on: {{ ref('v_stg_t24_t24_md_deal') }}
-- depends_on: {{ ref('hub_md_deal') }}

{{ config(
    alias = 'sts_hub_md_deal',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['md_deal_hashkey', 'source_event_date', 'cdc_status'],
