...
tags                : ['callcenter'] = filter khi run (dbt run --select tag:callcenter)
====================================================================
*/
{{ config(
    alias = 'hub_callcenter',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['callcenter_hashkey'],
    skip_matched_step = true,
    tags = ['callcenter', 'contact', 'phase2', 'all']
) }}

{% set source_name = 'callcenter' %}
{% set unique_key = 'callcenter_hashkey' %}
{% set business_key = '_id' %}
{% set source_table = 'callcenter' %}
{% set source_model = 'v_stg_callcenter_callcenter' %}
