...
*/
{{ config(
    alias = 'hub_qlns_nguoi_lao_dong_info',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['qlns_nguoi_lao_dong_info_hashkey'],
    skip_matched_step = true,
    tags = ['bpm', 'phase1', 'all']
) }}

{% set source_name = 'bpm' %}
{% set unique_key = 'qlns_nguoi_lao_dong_info_hashkey' %}
{% set business_key = 'ma_nhan_vien' %}
