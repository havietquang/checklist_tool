...
*/
{{ config(
    alias = 'hub_apportion_trans_batch_details',
    materialized = 'incremental_checkpoint',
    incremental_strategy = 'merge',
    unique_key = ['apportion_trans_batch_details_hashkey'],
    skip_matched_step = true,
    tags = ['ocbchannel', 'apportion_trans_batch_details', 'zonec']
) }}

{% set source_name = 'ocbchannel' %}
{% set unique_key = 'apportion_trans_batch_details_hashkey' %}
{% set business_key = 'batch_id' %}
